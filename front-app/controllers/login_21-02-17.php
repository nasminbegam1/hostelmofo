    ...
    public function forgotpassword(){
        ...
        if($this->input->post('action')=='Forgot-form' ){
            ...
            if($this->form_validation->run()){
                ...
                if($arrUser){
                    $reset_link	    = FRONTEND_URL.'change-password/'.md5($email_address);
						  ...
						  $template				=  $this->model_basic->getValues_conditions(EMAILTEMPLATE,array('email_content,email_subject'),'','template_id = 11');
						  ...
						  if($mailsnd){
                        $this->nsession->set_userdata('succmsg', 'Password sent to you email, Please check.');
                    }
                }
					 else{
