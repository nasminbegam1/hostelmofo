...
class Booking_details extends MY_Controller
{
	...
	public function index()
	{
		...
		$data['property_details']= $this->model_booking->all_booking();
	...
	public function future_bookings()
	{
		$this->chk_login();
		$cms_slug		=	$this->uri->segment(1);
		$data['property_details']= $this->model_booking->future_booking();
		$data['succMsg'] = $this->nsession->userdata('succMsg');
		$data['errMsg']	= $this->nsession->userdata('errMsg');
		$title = "Booking Details";
		//pr($data);
	...
	public function past_booking()
	{
		$this->chk_login();
		$cms_slug		=	$this->uri->segment(1);
		$data['property_details']= $this->model_booking->past_booking();
		$data['succMsg'] = $this->nsession->userdata('succMsg');
		$data['errMsg']	= $this->nsession->userdata('errMsg');
		$title = "Booking Details";
		//pr($data);
