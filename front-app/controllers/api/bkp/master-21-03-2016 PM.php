...
class Master extends REST_Controller{
	...
	if($property_detail){
	    $result = array('property_detail' => $property_detail, 'deals' => $dealDetails, 'reviews' => $avg_review['review_list'],'sum_rating' => $avg_review['sum_rating'],'avg_rating' => $avg_review['avg_rating'],'total_review' => $avg_review['total_review']);
	    $message = array('result' => $result,'message' => 'Record fetched successfully!');
	}else{
	    $message = array('message' => 'No data found!');
	}
	...
	$dataArr['currency_name']       = $this->input->post('currency');
	...
	else
	{
	    ...
	    $message = array('message' => 'Review added successfully!');
	    $this->response($message, 200);
	}
    }
}