...
//    echo $room_type_id 	= implode(",",$room_type_id);
//	 exit;
...
if($room_type_id <> ''){
$no_person = $this->model_basic->getValues_conditions('hw_agent_roomtype', array('size'), '', "room_type_master_id IN (".$room_type_id.")");
...
'check_in' 	=> $this->input->post('checkindt'),
'check_out'	=> $this->input->post('checkoutdt'),
