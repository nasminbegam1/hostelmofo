			  ...
			  if($isExists == 0)
			  {
				...
				//echo "bbb"; pr($dataArr);
					...
					if(!empty($ins_id) && $ins_id >0){
						...
						$this->model_basic->updateIntoTable('hw_payment_info',array('paymeny_id'=>$ins_id),array('reference_id'=>getInsID($ins_id)));
						...
						$payment = $this->model_basic->getValues_conditions('hw_payment_info','','','paymeny_id='.$ins_id);	  
