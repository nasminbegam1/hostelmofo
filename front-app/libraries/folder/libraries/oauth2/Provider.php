...
abstract class OAuth2_Provider
{
	...
	public function __construct(array $options = array())
	{
		...
		//$this->redirect_uri = 'http://codeigniter-development.com/hostelworld/auth_oa2/session/'.$this->name;
		//$this->redirect_uri = 'http://codeigniter-development.com/hostelworld/auth_oa2/session/google';
		//site_url(get_instance()->uri->uri_string());
	}
