...
class templatelayout {
     ...
     public function __construct(){
		...
		public function get_header($header=''){ 
				...
				$group_type = $this->obj->model_basic->getValues_conditions(GROUPTYPE, array('slug', 'typeName'), '', "status = 'active'", 'typeName', 'ASC');
				$this->header['grouptype'] = $group_type;
				
				$age_ranges = $this->obj->model_basic->getValues_conditions(AGEGROUP, array('id', 'ageGroup'), '', "status = 'active'", 'id', 'ASC');
				$this->header['ageGroup'] = $age_ranges;
		...
		public function get_inner_header($header=''){
				$this->header = '';
				$this->header['header_tab'] = array();
				...
				$this->header['header_selected']	= $header;
				$this->obj->elements['header']='layout/inner_header';
				$this->obj->elements_data['header'] = $this->header;
		}
		
		
		public function get_cms_header($header='',$title=''){
				$this->header = '';
				$this->header['header_tab'] = array();
				...
				$this->header['header_selected']	= $header;
				$this->obj->elements['header']='layout/cms_header';
				$this->obj->elements_data['header'] = $this->header;
		}
    ...
    public function get_footer(){
				...
				$this->obj->db->where_in('sitesettings_id',array(9,10,15,16,1,6,18,19,12));
				$query = $this->obj->db->get('hw_sitesettings');
				...
				$this->footer['contact_no']= $record[4]['sitesettings_value'];
				//$this->footer['social_links']['googleplus_link']= $record[5]['sitesettings_value'];
				//$this->footer['social_links']['linkedin_link']= $record[6]['sitesettings_value'];
				//$this->footer['social_links']['myspace_link']= $record[7]['sitesettings_value'];
				$this->footer['social_links']['pinterest_link']= $record[8]['sitesettings_value'];
				
				//pr($this->footer['contact_no']);
	    ...
	    public function get_inner_footer(){
				$this->footer = '';
				$this->footer['social_links']=array();
				$this->obj->db->where_in('sitesettings_id',array(9,10,15,16,1,6,18,19,12));
				$query = $this->obj->db->get('hw_sitesettings');
				...
				$this->obj->elements['footer']='layout/inner_footer';
				$this->obj->elements_data['footer'] = $this->footer;
     } 
		...
		public function get_banner_home($type=''){
				...
				//pr($this->banner['banner_list'],0);
				
				$this->banner['max_guest']	= $this->obj->model_basic->getValue_condition('hw_property_master','MAX(guest)');
				
				
				//pr($this->banner['max_guest'],0);
     ...
     public function get_landingbanner($banner_image='',$name= ''){
	  ...
	  public function get_banner($slug = '', $location = '', $type='', $typeid='',$property ='', $check_in = '', $check_out = '', $guest = '' ,$group_type = '',$age_ranges = '',$breadcrumb_arr='', $image_path=''){
				...
				$this->banner['property']		= $property;
				$this->banner['group_type']	= $group_type;
				$this->banner['age_ranges']	= $age_ranges;
				$this->banner['breadcrumb']	= $breadcrumb_arr;
				$this->banner['image_path']	= $image_path;
				
				$this->obj->elements['banner']			='layout/banner';
				$this->obj->elements_data['banner'] = $this->banner;
	  }
	  
	  public function get_banner_listing($slug = '', $location = '', $type='', $typeid='',$property ='', $check_in = '', $check_out = '', $guest = '' ,$group_type = '',$age_ranges = '',$breadcrumb_arr=''){
				...
				$this->obj->elements['banner']			='layout/banner_listing';
				$this->obj->elements_data['banner'] = $this->banner;
	  }
     
	  
	  public function get_banner_inner($header='',$title=''){
		
				$this->banner = '';	  
				$this->banner['banner_tab'] = array();	  
				$this->banner['title'] = $title;
				$this->banner['header_selected']	= $header;								
				$this->obj->elements['banner']			='layout/banner_inner';
				$this->obj->elements_data['banner'] = $this->banner;
	  }	  
     ...
     public function get_listing_leftpanel($ptype = array() ){
	  ...
	  $this->leftpanel['max_guest']	    = $this->obj->model_basic->getValue_condition('hw_property_master','MAX(guest)');
