...
<input type="hidden" name="room_price[<?php echo $i;?>]" value="<?php echo currentPrice1(stripslashes($room_price[$i]),$currencySymbol,$currencyRate);?>">
									...
									<table width="80%" cellspacing="0" cellpadding="0" border="0" class="paymentsummary">             
										<tr>
											...
											<td class="paynow" align="left">
												...
												<span>
													...
													<?php echo currentPrice1(stripslashes($total_room_price),$currencySymbol,$currencyRate); ?>
												</span>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="nofeeslist" align="left">
												<span><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?></span>
												<span id="total_payment"><?php echo currentPrice1($deposit_amount,$currencySymbol,$currencyRate);?></span>
											</td>
										</tr>
									</table>
				...
				<input type="hidden" name="property_price_total" id="property_price_total" value="<?php echo currentPrice1($total_room_price,$currencySymbol,$currencyRate);?>">
