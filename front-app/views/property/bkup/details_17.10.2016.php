	  ...
	  <div class="dorm_beds">
		...
		<span class="tooltrip"><?php echo stripslashes(ucwords($data['room_description'])); ?></span>
	      ...
	      <span class="avl_room_<?php echo $j;?> heighlight_text"></span>
              ...
              <td align="left" valign="top"><table class="rateTable" data-id="<?php echo $data['id'];?>" width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <?php for($i=1;$i<=8;$i++){?>
	  ...
	  <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="dateBody">
		...
		<span class="tooltrip"><?php echo stripslashes(ucwords($data['room_description'])); ?></span>
	      ...
	      <span class="avl_room_<?php echo $j;?> heighlight_text"></span></td>
              <td align="left" valign="top">
		<table data-id="<?php echo $data['id'];?>" class="rateTable"  width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <?php for($i=1;$i<=8;$i++){?>
                    <td align="left" valign="top"><span class="currency_smbl">
                      <?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?>
    ...
    <div class="rtBlock clearfix globalClr similarPro">
      ...
      <div class="formDiv globalClr gridView">
        ...
        <ul>
          ...
          <li class="item">
            <?php /*<div class="imgSec"><a href="<?php echo FRONTEND_URL.'property/'.$details['master_details']['property_type_slug'].'/'.$details['master_details']['province_slug'].'/'.$details['master_details']['city_seo_slug'].'/'.$item['property_slug']; ?>">*/?>
<div class="imgSec"><a href="<?php echo FRONTEND_URL.$details['master_details']['province_slug'].'/'.$details['master_details']['city_seo_slug'].'/'.$item['property_slug']; ?>">
        ...
        <p><a href="<?php echo FRONTEND_URL.'listing/?type='.$details['master_details']['property_type_slug'].'&guest='.$guest.'&city='.$details['master_details']['city_slug'].'&checkin='.str_replace("/", "-",$check_in).'&checkout='.str_replace("/", "-",$check_out).'&typeid='.$details['master_details']['property_type_id'].'&s=true' ; ?>" class="inputBtnOth blueBtn">View More Property</a></p>
        <?php } ?>
      </div>
    </div>
  </div>
