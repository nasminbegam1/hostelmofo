	...
	<div class="main">
		<div class="MainCon">
			<form name="frm" method="post" action="">
								...
								<div class="globalClr">
									...
									<table width="80%" cellspacing="0" cellpadding="0" border="0" class="paymentsummary">             
										...
										<tr id="standard_flexible_amount_row" style="display:none;">
											...
											<td align="left">
												<span><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?></span>
												<span><?php echo number_format($flexible_deposite_amount,2);?></span>
											</td>
										</tr>
										<tr id="flex_row" style="display: none;">
											...
											<td class="nofeeslist" align="left">
												<span>
													...
													<?php echo $flexible_deposite_amount;?>
												</span>
											</td>
										</tr>
										<tr>
											...
											<td class="nofeeslist" align="left">
												<span><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?></span>
												<span id="total_payment"><?php echo $deposit_amount;?></span>
											</td>
										</tr>
									</table>
					...
					<div class="targetDiv" id="user_details_section" style="display: none;" >
						<div class="allPopupBoxIn bigPop">
							<div class="bookFormPn globalClr popupInSec"> 
								...
								<input name="action" value="Process" type="hidden">
								<div class="formFiled globalClr">
									<div id="unregister_section two_col">
											...
											<select name="prefix_phone" id="prefix_phone" style="width: 120px;">
												...
												if(is_array($country_phone) ){
													foreach($country_phone as $phone){?>
														<option value="<?php echo $phone['phonecode']?>">
															<?php echo $phone['phonecode']." (". $phone['code'].")";?>
														</option>
														<?php
													}
												}
									...
									<div class="two_col">
										...
										<div class="innr_two_col">
											...
											<select name="gender" id="gender">
												...
												<?php
												if($checkGender == 1){ echo '<option value="Male">Male</option>'; }
				...
				<input type="hidden" name="property_price_total" id="property_price_total" value="<?php echo $property_price;?>">
				...
				<input type="hidden" name="downpayment_amount" id="downpayment_amount" value="<?php echo $downpayment_amount;?>">
