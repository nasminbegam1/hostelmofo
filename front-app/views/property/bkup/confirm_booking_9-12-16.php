	...
	<span><?php echo date('D jS M Y', strtotime($check_in))." - ".date('D jS M Y', strtotime($check_out));?></span>
		...
		?>
					<tr>
						...
						<td><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } echo currentPrice1(stripslashes($room_price[$i]),$currencySymbol,$currencyRate);?></td>
						<td><?php echo $no_room[$i]." ".$hosteltype[$i] ;?></td>
						<td><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } echo currentPrice1(stripslashes($tot_room_price[$i]),$currencySymbol,$currencyRate);?></td>
					</tr>
					...
					<input type="hidden" name="room_price[<?php echo $i;?>]" value="<?php echo $room_price[$i];?>">
					<input type="hidden" name="tot_room_price[<?php echo $i;?>]" value="<?php echo $tot_room_price[$i];?>">
		...
		<tr id="standard_flexible_amount_row" style="display:none;">
				...
				<td align="left"><span><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?> <span><?php echo currentPrice1($flexible_deposite_amount,$currencySymbol,$currencyRate);?></span></td>
				...
				<tr id="flex_row" style="display: none;">
                  ...
                  <td class="nofeeslist" align="left"><span><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?>
								<?php echo currentPrice1($flexible_deposite_amount,$currencySymbol,$currencyRate);?></span>
		</td>
            </tr>
