			...
			<form name="frm" method="post" action="">
					...
					<div class="targetDiv">
						<div class="allPopupBoxIn bigPop">
							<div class="bookFormPn globalClr popupInSec"> 
								...
								<div class="globalClr">
									<table id="no-more-tables" class="confPayment default_table">
										<thead>
										<tr>
										...
										if(is_array($room_type_id)){
											for($i=0;$i<count($room_type_id);$i++){?>
												<tr>
													<td data-title="My Section"><?php echo $room_name[$i];?></td>
													<td data-title="Price">
														<?php
														if($currencySymbol!=''){
															echo $currencySymbol;
														...
														$rprice = $tot_room_price[$i]/$no_room[$i];
														
														echo currentPrice1($rprice,$currencySymbol,$currencyRate);?>
													</td>
													<td data-title="Section"><?php echo $no_room[$i]." ".$hosteltype[$i] ;?></td>
													<td data-title="Total">
														<?php
														if($currencySymbol!=''){
															echo $currencySymbol;
												...
												<input type="hidden" name="room_price[<?php echo $i;?>]" value="<?php echo currentPrice1(stripslashes($rprice),$currencySymbol,$currencyRate);?>">
							...
							<div class="formFiled globalClr">
								...
								<div class="two_col">
									<div class="innr_two_col">
										...
										<select name="prefix_phone" id="prefix_phone" style="width: 34%;">
									...
									<input type="text" placeholder="Phone Number*" name="suffix_phone" id="suffix_phone" style="width: 65%;" onkeydown="javascript:return Numeric(event);">
									</div>
									<div class="innr_two_col">  
				...
				<div class="targetDiv inputDiv" id="payment_details_section" style="display: none;" >
					...
					<?php if($walletBlns <= 0){ ?>
						...
						<div class="intFiledDiv">
						<input required placeholder="CVV No*" maxlength="4" style="width: 34%;" name="cvv" id="cvv" class="requiredTextEnq" type="text">
						<select name="exp_month" style="width: 32%;" required="required">
							<option value="">Exp Month</option>
							<?php for($i=1;$i<=12;$i++){?>
							<option value="<?php echo sprintf("%'.02d",$i);?>"><?php echo sprintf("%'.02d",$i);?></option>
							<?php }?>
						</select>
						<select name="exp_year" style="width: 32%;" required="required">
