...
<tbody>
	<tr>
		...
		<td data-title="Total Amount">AUD $<?php echo (isset($payment_info[0]['property_price']))? round(($payment_info[0]['property_price']/$currencyRate)):'0';?></td>
 ...
 <table id="no-more-tables" width="100%" class="confPayment default_table">
    ...
    <tr>
      ...
      <td data-title="Price"><?php if($currencySymbol!=''){echo $currencySymbol; }else{ echo '$'; } ?><?php echo $room_price;//currentPrice1($room_price,$currencySymbol,$currencyRate);?></td>
