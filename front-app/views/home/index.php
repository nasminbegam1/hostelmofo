    <section class="background welcomePan">
    ...
    <section class="background MapPan">
       <div class="content-wrapper">
    ...
    <section class="background background appPan section" id="section4">
       <div class="content-wrapper">
          <div class="MainCon clearfix">
             ...
             <div class="appTxt alignleft">
                ...
                <div class="appBtn">
                   <a href="https://itunes.apple.com/in/app/hostelmofo/id1194419807?mt=8" target="_blank"><img src="<?php echo FRONT_IMAGE_PATH;?>app-str.png" alt="img"></a>
                   <a href="https://play.google.com/store/apps/details?id=com.hostelmofo" target="_blank"><img src="<?php echo FRONT_IMAGE_PATH;?>ggl-ply.png" alt="img"></a>
                </div>
             </div>
          </div>
       </div>
    </section>
    <section class="background mofoHvn">
       <div class="content-wrapper">
          <div class="MainCon">
    ...
    <section class="background twoSldr">
                  ...
                  <ul class="clearfix">
                     ...
                     if(is_array($adventure_location) && count($adventure_location) > 0){
                        foreach($adventure_location as $val){
                           ...
                           ?>
                        <li data-title="<img src='<?php echo $image_path;?>'/>">
    ...
    <section class="background mofoVibe">
       <div class="content-wrapper">
          <div class="MainCon">
             <h3> These places ooze mofo vibe</h3>
             <div class="mofovide_pnl owl-carousel owl-theme">
                <div class="item">
     ...
     <section class="background counterPan">
       <div class="content-wrapper">
        <div class="MainCon">
             <h3>
                <span class="count">5,2147</span>
                members and counting
             </h3>
        </div>
       </div>
    </section> 
    <section class="background australia">
       <div class="content-wrapper">
        <!--<img src="<?php echo FRONT_IMAGE_PATH;?>kang-bg.jpg" alt="" />-->
          <div class="blue">
             <div class="MainCon">
    ...
    <section class="background waiting">
       <div class="content-wrapper">
          <div class="MainCon clearfix">
    ...
    <section class="background kidPan">
       <div class="content-wrapper">
          <div class="MainCon clearfix">
             <div class="bleTxt"> Even these little guys <br> worked it out... </div>
          </div>
          <!--<img src="<?php echo FRONT_IMAGE_PATH;?>kid-bg.jpg" alt="" />-->
          
       </div>
    </section>
    <section class="background joinFrmPan">
       <div class="content-wrapper">
          <div class="MainCon clearfix">
    ...
    <section class="background advntrPan">
       <div class="content-wrapper">
         ...
         <!-- <img src="<?php echo FRONT_IMAGE_PATH;?>advn-bg.jpg" alt=""/>-->
       </div>
    </section>