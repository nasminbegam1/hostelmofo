...
<form action="" method="post" name="frm" id="profileFrm">
    ...
    <div class="formFiled globalClr clearfix">
        ...
        <div class="intFiledDiv hlfsz mrgof">
             ...
             <div class="mobile">
        <select name="country_code" id="country_code" style="width: 120px;">
            <option value="">Country Code</option>
            <?php
            if(is_array($country_phone) ){
                foreach($country_phone as $phone){?>
                    <option value="<?php echo $phone['phonecode']?>" <?php if($phone['phonecode'] == $user_details[0]['country_code']) echo "selected";?> ><?php echo $phone['phonecode']." (". $phone['code'].")";?></option>
                    <?php
                }
            }
            ?>
        </select>
        <input type="text" style="width: 71%;" name="phone" value="<?php echo $user_details[0]['mobile_no']; ?>" placeholder="Enter your phone no here">
        </div>
        </div>
