...
<section class="footer">   
   ...
   <div class="footTp for_web">
	  ...
	  <div class="for_mobile_logo" >
		 
	  <ul>
	   <li>
			 <?php
			 if($social_links['facebook_link'] && $social_links['facebook_link'] != '#' ){?>
				   <a target="_blank" href="<?php echo $social_links['facebook_link']; ?>" title="Facebook"></a>
				   <?php
			 }
			 ?>
	   </li>
	   <li>
			 <?php
			 if($social_links['twitter_link'] && $social_links['twitter_link'] != '#' ){?>
				   <a target="_blank" href="<?php echo $social_links['twitter_link']; ?>" title="Twitter"></a>
				   <?php
			 }
			 ?>
	   </li>
	   ...
	   <li>
			 <?php
			 if($social_links['pinterest_link'] && $social_links['pinterest_link'] != '#' ){?>
				   <a target="_blank" href="<?php echo $social_links['pinterest_link']; ?>" title="Pinterest"></a>
				   <?php
			 }
			 ?>
	   </li>
 ...
 <a href="#" class="backToTop">Back to top</a>
      ...
      <script src="<?php echo FRONT_JS_PATH;?>timepicki.js"></script>
