<header class="header">
	 ...
	 <?php if($image_path == ''){?>
         <img src="<?php echo FRONT_IMAGE_PATH;?>gal-banner.jpg" alt="no img" style="height: 475px;">
	 <?php } else {?>
		  <img src="<?php echo $image_path;?>" alt="no img">
	 <?php }?>
      ...
      <div class="formSrch clearfix">
	    ...
	    <?php
	    /*
	    $check_in_bann = explode('-',$check_in);
	    $check_out_bann = explode('-',$check_out);
	    ?>
            <input value="<?php echo $check_in_bann[2].'/'.$check_in_bann[1].'/'.$check_in_bann[0];?>" name="checkin" id="checkIn" placeholder="Enter checkin date" type="text" readonly=true>
            <label class="out">Check Out</label>
            <input value="<?php echo $check_out_bann[2].'/'.$check_out_bann[1].'/'.$check_out_bann[0];?>" name="checkout" id="checkOut" placeholder="Enter checkout date" type="text" readonly=true>
            <?php */ ?>
