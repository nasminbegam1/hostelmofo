...
<div class="banner_pnl owl-carousel owl-theme">
	 <?php
	 if(is_array($banner_list)){
		  foreach($banner_list as $banner){?>
				 <div class="item">
						...
						<!--<img src="images/ban1.jpg" alt="banner">-->
						<div class="home_banner" style="background-image:url('images/ban1.jpg'); height: 250px;"></div>      
						<span></span>
				 </div>
				 <?php
		  }
