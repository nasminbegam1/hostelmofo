...
$route['how-we-use-your-data/(:any)']           = 'cms_page/cms_details';
$route['cancel-booking/(:any)']                 = 'cms_page/cms_details';

//$route['property-rent/(:any)']                = 'property/details/$1';
$route['property/direction/(:any)/(:any)/(:any)/(:any)/(:any)']   = 'property/property_direction/$1/$2/$3/$4/$5/';
$route['property/(:any)/(:any)/(:any)/(:any)/(:any)']   = 'property/details/$1/$2/$3/$4/$5';
...
$route['change-password/:any']                  = 'login/reset_url/$1';
$route['feedback/success']                      = 'feedback/success';
$route['feedback/:any']                         = 'feedback/index/$1';
/* For web services */
$route['api/register']          = 'redeemapi/register';
