							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-9">
										<div class="col-md-3">	
												 <input id="filter_month" type="text" class="form-control date-picker" readonly name="filter_month" value="<?php echo date('m-Y'); ?>">
										</div>
										<div class="col-md-3">	
											 <input type="submit" class="btn btn-default blue" value="Select Date" id="btn_search" name="btn_search">
										</div>
										</div>
									</div>
								</div>
