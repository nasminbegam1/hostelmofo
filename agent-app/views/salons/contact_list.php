	  ...
	  <!-- END STYLE CUSTOMIZER -->
			  ...
			  <!-- BEGIN PAGE HEADER-->
			  <h3 class="page-title"> Salons Contact List</h3>
				  ...
				  <div class="portlet light">
				    <div class="row">
					  ...
					  <div class="portlet box">
						  ...
						  <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo ADMIN_URL;?>salons/view_contact/<?php echo $salon_id;?>/<?php echo $page; ?>">
						      <div class="row">
							  <div class="col-sm-4">
				    ...
				    <div class="row">
					  ...
					  <div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">Salon Contact Listing - <?php echo $getSingle[0]['salon_name'];?></div>
						</div>
					      <div class="portlet-body">
						      ...
						      <thead>
							    <tr>
							      ...
							      <th data-hide="phone,tablet">User Email</th>
							...
							?>
							  ...
							  <td><?php echo stripslashes($records[$i]['users_first_name']).' '.stripslashes($records[$i]['users_last_name']);?></td>
							  <td><?php echo stripslashes($records[$i]['users_email']);?></td>
							  <td><?php if($records[$i]['users_mobile'] != ''){echo stripslashes($records[$i]['users_mobile']);}else{echo '--';}?></td>
							  <td><?php echo stripslashes($records[$i]['type_name']);?></td>
