	  ...
	  <!-- END STYLE CUSTOMIZER -->
			  ...
			  <!-- BEGIN PAGE HEADER-->
			  <h3 class="page-title"> Salon Inventory List</h3>
				  ...
				  <div class="portlet light">
				    <div class="row">
					  ...
					  <div class="portlet box">
						  ...
						  <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo ADMIN_URL;?>salons/view_inventory/<?php echo $salon_id;?>/<?php echo $page; ?>">
						      <div class="row">
							  <div class="col-sm-4">
				    ...
				    <div class="row">
					  ...
					  <div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">Salon Inventory Listing - <?php echo $getSingle[0]['salon_name'];?></div>
						</div>							
					      <div class="portlet-body">
						      ...
						      <thead>
							    <tr>
							      ...
							      <th data-hide="phone,tablet">Purchased on</th>
							      <th data-hide="phone,tablet">Type</th>
							      <th data-hide="phone,tablet">Volume</th>
							      <th data-hide="phone,tablet">Quantity</th>
							      <th data-hide="phone,tablet">Cost price</th>
							      <th data-hide="phone,tablet">Sell Price</th>
							      <th data-hide="phone,tablet">Process</th>
							...
							?>
							  ...
							  for($i=0; $i<count($records); $i++){
							       // $contactDetails = str_replace("{{ID}}",$records[$i]['users_id'],$contact_details);
								//$contactDetails = str_replace("{{SALON_ID}}",$records[$i]['salon_id'],$contactDetails);
							  ...
							  <td><?php echo stripslashes($records[$i]['product_name']);?></td>
							  <td><?php echo date('jS M, Y', strtotime($records[$i]['purchased_date']));?></td>
							  <td><?php echo stripslashes($records[$i]['product_type']);?></td>
							  <td><?php echo stripslashes($records[$i]['volume']);?></td>
							  <td><?php echo stripslashes($records[$i]['quantity']);?></td>
							  <td><?php echo stripslashes($records[$i]['cost_price']);?></td>
							  <td><?php echo stripslashes($records[$i]['sell_price']);?></td>
							  <td><?php echo stripslashes($records[$i]['inventory_process']);?></td>
							  <!--<td></td>-->
							  ...
							  <!--<td><button type="button" class="btn dark" onclick="javascript:window.location.href='<?php //echo $contactDetails;?>'" title="View">View</button></td>	-->
						      </tr>
						      <?php } }  else {  ?>
