         ...
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div>
					    <form action="<?php echo AGENT_URL.'property/editpriceaction/'.$property_details['property_master']['property_master_id'] ?>" class="form-horizontal PropEditForm" id="propertyAddFrm" method="post" enctype="multipart/form-data">
					...
					<div id="tab4-wizard-custom-circle" class="tab-pane fadeIn active">
					    ...
					    <div style="clear: both"></div>
					       ...
					       <div class="form-group"><label class="col-sm-3 control-label" for="contact_name">Deposit Amount (%)</label>
