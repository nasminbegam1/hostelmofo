...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">Deals Details</h3>
<?=$property_header?>
    <!-- END PAGE HEADER-->
...
<h3 class="page-title"> Deals List</h3>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 >Deals search Panel</h4>
                                        ...
                                        <div class="table-container">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                if(is_array($dealsList) && !empty($dealsList))
                                                {
                                                foreach($dealsList as $property)
                                                {
                                                 $room_type_value = explode(',',$property['room_type_value']);
                                              ...
                                              //$bookinglink = str_re
                                                ...
                                                $format =  strtotime($property['from_date']);
                                                $format1 = strtotime($property['to_date']);

                                               $formatChange = date("l dS \f F y ",$format1);
                                               $formatChange1 = date("l dS \f F y ",$format);

                                                

                                            $diff_time = ( $format1- $format);
                                             $night = floor($diff_time/(60*60*24));


                                                ?>  
                                                <tr>
                            
                            <td data-title="Name"><?php echo stripslashes($property['deal_name']);?></td>
                            <td data-title="Province">
                            <?php
                            if(is_array($property['room_type']) && isset($property['room_type'])){
                                       $roomTypeNmae = $property['room_type'];
                                       for($i=0;$i<count($roomTypeNmae);$i++){

                                    
                                     echo '-'.$room_type_value[$i].' ';
                                     echo $roomTypeNmae[$i]['type_name']; ?>
                                     <br> 
                                       
                                 <?php      } }else{echo '0';}

                                         ?></td>
                            <td><?php echo stripslashes($night);?></td>
                            <td data-title="Type"><?php echo stripslashes($property['price']);?></td>
                            <td data-title="Type"><?php echo $formatChange;?></br>Until<br><?php echo $formatChange1;?></td>
                            <td data-title="Action" width='10%' style="text-align: center;">
                            <div >
                                            


                                 <?php $id = $property['deal_id'];?>
                            
                            <a href="<?php echo AGENT_URL.'property/deal_edit/'.$property_id.'/'.$id ;?>" class="tablectrl_small bDefault tipS previewLink" title="Edit">
