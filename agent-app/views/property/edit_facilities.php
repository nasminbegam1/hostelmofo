         ...
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div>
					    <form action="<?php echo AGENT_URL.'property1/editfacilitiesaction/'.$property_details['property_master']['property_master_id'] ?>" class="form-horizontal form-validate" id="propertyAddFrm" method="post" enctype="multipart/form-data">
					...
					<div id="tab5-wizard-custom-circle" class="tab-pane fadeIn active">
						...
						<div class="form-group">
                                                    <div class="col-sm-12">
							<div class="col-sm-6">
							    <label for="earliest_check_in" class="col-sm-3 control-label">Earliest Check in</label>
							...
							<div class="col-sm-6">
							<label for="latest_check_in" class="col-sm-3 control-label">Latest Check out</label>
...
-->					<div class="action text-right">
                                            <a href="<?php echo base_url().'property1/editpriceaction/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>"><button type="button" name="previous" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button></a>
