                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div>
					    <form action="<?php echo AGENT_URL.'property1/editimageaction/'.$property_details['property_master']['property_master_id'] ?>" class="form-horizontal" id="propertyAddFrm" method="post" enctype="multipart/form-data">
						...
						<tbody class="files prePropertyImages">
						   ...
						   <tr class="imageinfo  <?php echo ($img['featured_image']=='Yes')? 'note note-danger':'note note-warning'; ?>" data-item="<?php echo $img['property_image_id'];?>">
							<td  width="12%">
							    ...
							    <img width="70" height="70" src="<?php echo FILE_UPLOAD_URL.'property/small/'.$img['image_name']; ?>"/>
...
-->					<div class="action text-right">
                                            <a href="<?php echo base_url().'property1/editfacilitiesaction/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>"><button type="button" name="previous" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button></a>
