         ...
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div>
					    <form action="<?php echo AGENT_URL.'property1/editpriceaction/'.$property_details['property_master']['property_master_id'] ?>" class="form-horizontal PropEditForm" id="propertyAddFrm" method="post" enctype="multipart/form-data">
					...
					<div class="form-group"><label class="col-sm-3 control-label" for="contact_name">Service Fee (%)</label>
						...
						?>
						    ...
						    <div class="col-mb-12">
							<h3><?php echo $new_prices[$diff]['roomtype_name']; ?></h3>
...
-->					<div class="action text-right">
                                            <a href="<?php echo base_url().'property1/editbasicaction/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>"><button type="button" name="previous" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button></a>
