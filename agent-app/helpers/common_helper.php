...
//if(!function_exists('BuildEmailMessageSteAdmin')){
//	function BuildEmailMessageSteAdmin($message, $SalonId) {
//		$CI = & get_instance();
//		$salonuser =$CI->model_basic->getValues_conditions('bs_salon_users','','','salon_id='.$SalonId.' and users_type=5');
//		$sitename =$CI->model_basic->getValues_conditions('bs_sitesettings','sitesettings_value','','sitesettings_id=6');
//		$message = stripslashes($message);
//		$RplVeriables =	array(
//			      'SALON_OWNER_NAME'=>$salonuser[0]['users_first_name'].' '.$salonuser[0]['users_last_name'],
//			      'SITE_NAME'=>$sitename[0]['sitesettings_value'],
//			      'SITE_URL'=>FRONTEND_URL,
//			      'SALON_OWNER_ADMIN_URL'=>SALON_OWNER_ADMIN_URL,
//			      'SALON_OWNER_EMAIL'=>$salonuser[0]['users_email'],
//			      'SALON_OWNER_PASSWORD'=>$salonuser[0]['users_password']
//			      );
