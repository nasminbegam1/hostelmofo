    ...
    DayPilotMonth.Month = function(placeholder) {
        ...
        this._loadEvents = function() {
            ...
            for (var x = 0; x < events.length; x++) {
                var e = new DayPilot.Event(events[x], this);
        ...
        this.drawEvent = function(ep) {
            ...
            if (this.cssOnly) {
                ...
                inner.innerHTML = ep.client.html();
            }
            else {
        ...
        this.drawCell = function(x, y, table) {
            ...
            if (date === 1) {
                day.innerHTML = resolved.locale().monthNames[d.getUTCMonth()] + ' ' + date;
            }
            else {
                day.innerHTML = date;
            }
        ...
        this.eventMoveDispatch = function(e, x, y, offset, ev, position) {
            ...
            if (calendar._api2()) {
                ...
                switch (calendar.eventMoveHandling) {
                    case 'CallBack':
                        calendar.eventMoveHandling(e, newStart, newEnd);
                        break;
                    case 'Update':
                        e.start(newStart);
                        e.end(newEnd);
