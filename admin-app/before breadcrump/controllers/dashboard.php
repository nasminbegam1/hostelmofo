...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$total_property = $genaral['booking_property']['total_live'];
		$fields		=	array();
		$fields[0]	=	'COUNT(*) as no_of_property';
		
		$last_min_property	=	$this->model_basic->getValues_conditions('lp_rent_master',$fields,'',' `deal_status` = "active" AND `discount_rate` > 0');
		
		$genaral['last_min_property']	=	$last_min_property[0]['no_of_property'];	
		$this->data['deal_percent'] = ($genaral['last_min_property']/$total_property)*100;
