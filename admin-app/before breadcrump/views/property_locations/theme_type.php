...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Theme Type Master</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-building-o"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Theme Type</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><a href="<?php echo $show_all;?>" ><i class="fa fa-building-o"></i>&nbsp;&nbsp;Listing</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Theme Type Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property_locations/themetypes/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                <thead>
                                                <tr>
						 <th style="width:10%;"><input type="checkbox" class="checkall" id="checkallbox" name="checkallbox"/></th>
						<th data-toggle="true" style="width:10%;">Theme Type Name</th>
                                                <th data-sort-ignore="true" style="width:10%;">Theme Type icon</th>
                                                <th style="width:10%;">Status</th>
                                                <th data-sort-ignore="true" style="width:10%;text-align: center;">Actions</th>
						</tr>
                                                </thead>
                                                <tbody>
			    <?php 
                            if($themeTypeList){
                            for($i=0; $i<count($themeTypeList); $i++){                                
                                $editLink	= str_replace("{{ID}}",$themeTypeList[$i]['theme_type_id'],$edit_link);
								
				$deleteLink	= str_replace("{{ID}}",$themeTypeList[$i]['theme_type_id'],$delete_link);
                                $db_user_image  = stripslashes($themeTypeList[$i]['theme_type_id']);
                                $class = 'class="even"';
 				if($i%2==0)
				  $class = 'class="even"';
				else
				  $class = 'class="odd"';
                        ?>
                        <tr <?php echo $class; ?>>
                          <td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $themeTypeList[$i]['theme_type_id'];?>" /></td>
                          <td><?php echo stripslashes($themeTypeList[$i]['theme_type_name']);?></td>
			  <td><img src="<?php echo file_upload_base_url();?>themeicons/<?php echo $themeTypeList[$i]['theme_icon'];?>" border="0"></td>
			  <td><?php echo stripslashes($themeTypeList[$i]['theme_type_status']);?></td>
