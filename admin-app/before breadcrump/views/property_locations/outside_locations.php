...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Outside Location Master</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-map-marker"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Outside Location Master</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Outside Location Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property_locations/property_outside_locations/0/0/outside">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                <thead>
                                                <tr>
						 <th style="width:5%;"><input type="checkbox" class="checkall" id="checkallbox" name="checkallbox"/></th>
						<th style="width:10%;">Location</th>
                                                <th data-toggle="true" style="width:10%;">Location title1</th>
                                                <th data-toggle="true" style="width:10%;">Location title2</th>
                                                <th data-toggle="true" style="width:10%;">Location title3</th>
                                                <th data-toggle="true" style="width:10%;">Location title4</th>				
                                                <th style="width:10%;">Status</th>
                                                <th data-sort-ignore="true" style="width:15%;text-align: center;">Actions</th>
						</tr>
                                                </thead>
                                                <tbody>
			   <?php 
                            if($propertyOutsideLocations){
                            for($i=0; $i<count($propertyOutsideLocations); $i++){                                
                                $editLink	= str_replace("{{ID}}",$propertyOutsideLocations[$i]['id'],$edit_link);
				$deleteLink	= str_replace("{{ID}}",$propertyOutsideLocations[$i]['id'],$delete_link);
                                $db_user_image  = stripslashes($propertyOutsideLocations[$i]['id']);
                                $class = 'class="even"';
 				if($i%2==0)
				  $class = 'class="even"';
				else
				  $class = 'class="odd"';
                        ?>
                        <tr <?php echo $class; ?>>
                          <td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $propertyOutsideLocations[$i]['id'];?>" /></td>
                          <td><?php echo stripslashes($propertyOutsideLocations[$i]['location_name']);?></td>
			  <td><?php echo stripslashes($propertyOutsideLocations[$i]['title1']);?></td>
                          <td><?php echo stripslashes($propertyOutsideLocations[$i]['title2']);?></td>
                          <td><?php echo stripslashes($propertyOutsideLocations[$i]['title3']);?></td>
                          <td><?php echo stripslashes($propertyOutsideLocations[$i]['title4']);?></td>			 
			  <td><?php echo stripslashes($propertyOutsideLocations[$i]['status']);?></td>
