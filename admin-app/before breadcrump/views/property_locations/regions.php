...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Region Master</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-map-marker"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Region</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            ...
            <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Region Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property_locations/regions/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
						 ...
						 <th ><input type="checkbox" class="checkall" id="checkallbox" name="checkallbox"/></th>
                                                <th data-toggle="true">Region Name</th>
                                                <th>Status</th>
			    ...
			    <?php 
                            ...
                            for($i=0; $i<count($regionList); $i++){                                
                                $editLink	= str_replace("{{ID}}",$regionList[$i]['region_id'],$edit_link);
				$deleteLink	= str_replace("{{ID}}",$regionList[$i]['region_id'],$delete_link);
                                $db_user_image  = stripslashes($regionList[$i]['region_id']);
                                $class = 'class="even"';
 				if($i%2==0)
				  $class = 'class="even"';
				else
				  $class = 'class="odd"';
                        ?>
                        <tr <?php echo $class; ?>>
                          <td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $regionList[$i]['region_id'];?>" /></td>
                          <td><?php echo stripslashes($regionList[$i]['region_name']);?></td>
			  <td><?php echo stripslashes($regionList[$i]['region_status']);?></td>
                          <td>N/A
