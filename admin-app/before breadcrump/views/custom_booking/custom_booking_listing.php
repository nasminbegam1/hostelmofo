...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Custom Booking</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-check-square-o"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Custom Booking Url</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
...
<!--BEGIN CONTENT-->
            ...
            <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Booking Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>custom_booking/listing/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."custom_booking/batch_action/0/".$page;?>" method="post">
						 ...
						 <th style="width: 10%;" data-toggle="true">Property Name</th>
                                                ...
                                                <th style="width: 9%;" data-toggle="true">Discount<br />Percent</th>
                                                <th style="width: 9%;" data-toggle="true">Expired</th>
                                                <th style="width: 10%;" data-sort-ignore="true">Added on</th>
			  ...
			  //pr($enquiryList);
			        ...
			        if($bookingList[$i]['customer_email']=='') {
			          $email ='';
			       } else {
				  $email = stripslashes($bookingList[$i]['customer_email']);
			       }	 
				$viewLink = str_replace("{{ID}}",$bookingList[$i]['cb_id'],$view_link);
				$leadLink = str_replace("{{ID}}",$bookingList[$i]['cb_id'],$lead_link);
				$deleteLink = str_replace("{{ID}}",$bookingList[$i]['cb_id'],$delete_link);				
				...
				if($i%2==0)
					...
					$class = 'class="odd"';
                        ...
                        <tr>
                            <td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $bookingList[$i]['cb_id'];?>" /></td>
                            <td><?php echo stripslashes($bookingList[$i]['property_name']);?></td>
                            <td><?php echo $email;?></td>
			    <td><?php echo $bookingList[$i]['checkin'];?></td>
			    <td><?php echo $bookingList[$i]['checkout'];?></td>
			    <td><?php echo 'THB '.$bookingList[$i]['discountprice'];?></td>
			    <td><?php echo number_format($bookingList[$i]['discountpercent']);?></td>
			    <td><?php echo ucwords($bookingList[$i]['expired']);?></td>
			    <td><?php echo @date("d/m/Y H:i:s", strtotime($bookingList[$i]['cb_added_on']));?></td>
			     <td>
			      <a class="various3 previewLinkBtn changeStatus" href="<?php echo FRONTEND_URL."newversion/yourbooking/".$bookingList[$i]['custom_key'];?>" target="_blank">
                                <!--<span class=" property_list property_list_preview btn btn-orange">Booking Link</span>-->
                                <button type="button" class="btn btn-info btn-orange btn-xs"><i class="fa fa-link"></i>&nbsp;
                                                            Booking Link
                                </button>
			      ...
			      <?php if($bookingList[$i]['expired'] == 'no'){?>
			      <a class="various3 previewLinkBtn changeStatus" href="<?php echo BACKEND_URL."custom_booking/viewcustom/".$bookingList[$i]['custom_key'];?>">
                                <!--<span class=" property_list property_list_preview  btn btn-blue">Edit</span>-->
