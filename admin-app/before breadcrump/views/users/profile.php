...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right">
        ...
        <li><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Profile</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="<?php echo $profile_url;?>" >Admin Profile</a></li>
            ...
            <div class="page-content">
				...
				?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="tab-content">
                                                    <div id="tab-profile-setting" class="tab-pane fade <?php if(!isset($profile_type) || $profile_type == '' ) echo 'active in'; ?>">
                                                        <form action="" class="form-validate1 form-horizontal" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <center>
                                                                ...
                                                                <img class="img-circle" src="<?php echo FILE_UPLOAD_URL;?>admin/<?php echo $image;?>"style="border: 5px solid #fff; box-shadow: 0 2px 3px rgba(0,0,0,0.25);" width="140" height="140">
                                                            </center>
                                                             <?php } ?>
                                                            </div>
                                                    ...
                                                    <div id="tab-contact-setting" class="tab-pane fade <?php if(isset($profile_type) && $profile_type == 'contact' ) echo 'active in'; ?>">
                                                        <form action="" class="form-horizontal" method="post">
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Mobile Phone</label>

                                                                <div class="col-sm-9 controls">
                                                                    <input type="hidden" name="contact" value="editcontact" />
                                                                    <input type="text"name="phone_no" id="phone_no" placeholder="0-123-456-789" class="form-control" value="<?php echo stripslashes($user_info[0]['phone_no']);?>"/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group"><label class="col-sm-3 control-label">Skype Id</label>

                                                                <div class="col-sm-9 controls"><input type="text" name="skype_id" id="skype_id" placeholder="" class="form-control" value="<?php echo stripslashes($user_info[0]['skype_id']);?>"/></div>
                                                            </div>
							...
							<a href="#tab-account-setting" data-toggle="tab"><i class="fa fa-cogs"></i>&nbsp;
                                                    ...
                                                    <li class="<?php if(isset($profile_type) && $profile_type == 'contact' ) echo 'active'; ?>">
							<a href="#tab-contact-setting" data-toggle="tab"><i class="fa fa-envelope-o"></i>&nbsp;
                                                        Contact Setting</a>
						    </li>
                                                </ul>
                                            </div>
