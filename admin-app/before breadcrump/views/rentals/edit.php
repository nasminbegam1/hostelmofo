                            ...
                            <div class="portlet-body">
                                <div id="rootwizard-custom-circle">
                                    ...
                                    <div class="tab-content">
                                        <form action="<?php echo BACKEND_URL;?>property_rental/edit_rentalproperty/<?php echo $property_id.'/'.$page; ?>" class="form-validate form-horizontal" enctype="multipart/form-data" method="post">
                                                            ...
                                                            <div class="form-body pal">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <label class="radio-inline"><input type="radio" value="Flexible" id="cancellation_policy1" name="cancellation_policy" <?php if($property_details['cancellation_policy']=='Flexible'){echo 'checked';}?>/>&nbsp;
                                                                                    Flexible</label>
                                                                                <label class="radio-inline"><input type="radio" value="Moderate" id="cancellation_policy2" name="cancellation_policy" <?php if($property_details['cancellation_policy']=='Moderate'){echo 'checked';}?>/>&nbsp;
                                                                                    Moderate</label>
                                                                                <label class="radio-inline"><input type="radio" value="Strict" id="cancellation_policy3" name="cancellation_policy"  <?php if($property_details['cancellation_policy']=='Strict'){echo 'checked';}?>/>&nbsp;
                                                                                    Strict</label>
                                                                                <label class="radio-inline"><input type="radio" value="SuperStrict" id="cancellation_policy4" name="cancellation_policy" <?php if($property_details['cancellation_policy']=='SuperStrict'){echo 'checked';}?> />&nbsp;
                                                                                    Super Strict</label>
                                                                                <label class="radio-inline"><input type="radio" value="LongTerm" id="cancellation_policy4" name="cancellation_policy" <?php if($property_details['cancellation_policy']=='LongTerm'){echo 'checked';}?>/>&nbsp;
                                                                                    Long Term</label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-10 input-icon"><input id="check_in_out_text" name="check_in_out_text" type="text" placeholder="" class="form-control" value="<?php echo htmlspecialchars(stripslashes($property_details['check_in_out_text'])); ?>"/></div>
                                                                    </div>
                                                                   </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label for="security_deposit" class="col-md-4 control-label">Security Deposit <span class='require'>*</span></label>
                                                                                ...
                                                                                <input id="security_deposit" name="security_deposit" type="text" placeholder="" class="form-control required" value="<?php echo htmlspecialchars(stripslashes($property_details['security_deposite']));?>"/>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label for="security_deposit_text" class="col-md-4 control-label"> Security Deposit Text </label>
                                                                            ...
                                                                            <div class="col-md-8">
                                                                               ...
                                                                               <input id="security_deposit_text" name="security_deposit_text" type="text" placeholder="" class="form-control" value="<?php echo htmlspecialchars(stripslashes($property_details['security_deposit_text']));?>"/>
