                            ...
                            <div class="portlet-body">
                                <div id="rootwizard-custom-circle">
                                    ...
                                    <div class="tab-content">
                                        <form action="<?php echo BACKEND_URL;?>property_rental/contact/<?php echo $arr_property['property_id'].'/'.$page;?>" class="form-validate form-horizontal" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="action text-right">
                                            <button type="button" name="previous" onclick="javascript:go_to('<?php echo base_url().'property_rental/payment/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button>
