...
<script type="text/javascript" src="<?php echo BACKEND_JS_PATH; ?>jquery.uploadfile.js"></script>
                                ...
                                <!--        TAB SECTION                    -->
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <div class="tools">
                                                        ...
                                                        <div class="portlet-body ">
                                                            ...
                                                            <div class="action action-top text-right">
                                                                <button type="button" name="previous" onclick="javascript:go_to('<?php echo base_url().'property_rental/edit_rentalproperty/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button>
                                                                <button type="button" name="next" onclick="javascript:go_to('<?php echo base_url().'property_rental/ical/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Next" class="btn btn-info button-next mlm">Next<i class="fa fa-arrow-circle-o-right mlx"></i></button>
                                        ...
                                        <div class="action text-right">
                                            <button type="button" name="previous" onclick="javascript:go_to('<?php echo base_url().'property_rental/edit_rentalproperty/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button>
                                            <button type="button" name="next" value="Next" onclick="javascript:go_to('<?php echo base_url().'property_rental/ical/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" class="btn btn-info button-next mlm">Next<i class="fa fa-arrow-circle-o-right mlx"></i></button>
                                        </div>
   ...
   var  succ_msg = '<?php echo $succmsg; ?>';
    ...
    $(window).load(function(){
            ...
            var settings = {
                    url:  backend_url + "property_rental/do_image_upload",
                    method: "POST",
    ...
    function add_image(property_id,display_image_name,is_feature){
        ...
        $.ajax({
                    type: "POST",
                    dataType: "HTML",
                    url: backend_url + "property_rental/add_property_image/",
    ...
    function update_image_data(property_image_id){
        ...
        $.ajax({
                type: "POST",
                dataType: "HTML",
                url: backend_url + "property_rental/update_image_data/",
