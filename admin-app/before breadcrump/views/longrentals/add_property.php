                                ...
                                <div id="rootwizard-custom-circle">
                                   <?= $tabs ?>
                                    ...
                                    <div class="tab-content">
                                        <form action="<?php echo BACKEND_URL;?>longrentals/add/" class="form-validate form-horizontal" enctype="multipart/form-data" method="post">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label for="is_studio" class="col-md-4 control-label">Studio </label>
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    ...
                                                                                    <label class="radio-inline"><input type="radio" value="Yes" id="is_studio" name="is_studio" <?php echo  set_radio('is_studio',"Yes",true)?>/>&nbsp;
                                                                                    Yes</label><label class="radio-inline"><input type="radio" value="No" id="is_studio" name="is_studio" <?php echo set_radio('is_studio',"No")?>/>&nbsp;
                                                                                    No</label>
