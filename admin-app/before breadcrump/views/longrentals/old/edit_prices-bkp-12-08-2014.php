    	...
    	<div class="row">
			...
			<div class="col-sm-3">
						  ...
						  <?php if($season_price_list[$p]['season_start_date'] != '' && $season_price_list[$p]['season_start_date'] != '1970-01-01 00:00:00' && $season_price_list[$p]['season_start_date'] !='0000-00-00 00:00:00'){ ?>
						    <input readonly value="<?php echo date("d/m/Y", strtotime($season_price_list[$p]['season_start_date']));?>" type="text"  data-required="true" onchange="checkSeasionDate(this);" item="<?php echo $season_price_list[$p]['price_id']; ?>"  class="season_start_date system_record form-controltwo required" name="season_start_date[]" id="start_date_id<?php echo $season_price_list[$p]['price_id']; ?>">
						  <?php } else { ?>
						    <input value="" type="text" data-required="true" onchange="checkSeasionDate(this);" class="season_start_date form-controltwo required" name="season_start_date[]" >
						  <?php } ?>
						</div>
                        <div class="col-sm-3">
						  <label for="reg_input_name" class="req">Season End Date</label>
						   <?php if($season_price_list[$p]['season_end_date'] != '' && $season_price_list[$p]['season_end_date'] != '1970-01-01 00:00:00' && $season_price_list[$p]['season_end_date'] !='0000-00-00 00:00:00'){ ?>
						    <input value="<?php echo date("d/m/Y", strtotime($season_price_list[$p]['season_end_date']));?>" type="text" data-required="true"  class="season_start_date system_record form-controltwo required" onchange="checkSeasionDate(this);" name="season_end_date[]" item="<?php echo $season_price_list[$p]['price_id']; ?>" id="end_date_id<?php echo $season_price_list[$p]['price_id']; ?>">
						  <?php } else { ?>
						    <input readonly value="" type="text" data-required="true" onchange="checkSeasionDate(this);"  class="season_start_date form-controltwo required" name="season_end_date[]" >
						  <?php } ?>
						</div>
			<div class="col-sm-3">
			    <?php //pr($season_price_list); ?>
					...
					<?php }
                        ...
                        <div class="col-sm-3">
						  <label for="reg_input_name" class="req">Season Start Date</label>
						  <input readonly value="" type="text" onchange="checkSeasionDate(this);" data-required="true"  class="season_start_date form-controltwo required" name="season_start_date[]">
						</div>
                        <div class="col-sm-3">
						  <label for="reg_input_name" class="req">Season End Date</label>
						  <input readonly value="" type="text" onchange="checkSeasionDate(this);" data-required="true" class="season_start_date form-controltwo required" name="season_end_date[]">
						</div>
			<div class="col-sm-3">
						  <label for="reg_input_name" class="req"> Is Default Season ?</label>
