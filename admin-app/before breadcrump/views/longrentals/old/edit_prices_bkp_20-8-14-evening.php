					...
					?>
					   <!-- <tr><td>&nbsp;</td></tr>-->
						...
						<div class="col-sm-3 rentDailyPricePan">
						  ...
						  <input type="hidden" name="dailyPriceTmp[]" id="dailyPriceTmp_<?php echo $p; ?>" value="">
						...
						<div class="col-sm-3 rentWeeklyPricePan">
						  ...
						  <div id="weeklyPricePan_<?php echo $p; ?>" class="weeklyAutoPricePan">
						   <div class="pan1">
						    <span><a id="weeklyMPrice_<?php echo $p; ?>" href="javascript:void(0);" class="weeklyMPrice <?php if($season_price_list[$p]['weekly_disc'] == 'M'){ echo 'active';} ?>">M</a></span>
						    <span><a id="weekly0Price_<?php echo $p; ?>" href="javascript:void(0);" class="weekly0Price <?php if($season_price_list[$p]['weekly_disc'] == 0 && $season_price_list[$p]['weekly_disc']!='' && $season_price_list[$p]['weekly_disc']!='M'){ echo 'active';} ?>">0</a></span></div>
						    <div class="pan2">
						...
						<div class="col-sm-3 rentMonthlyPricePan">
						  ...
						  <div id="monthlyPricePan_<?php echo $p; ?>" class="monthlyAutoPricePan">
						    <div class="pan1">
							<span><a id="monthlyMPrice_<?php echo $p; ?>" href="javascript:void(0);" class="monthlyMPrice <?php if($season_price_list[$p]['monthly_disc'] == 'M'){ echo 'active';} ?>">M</a></span>
							<span><a id="monthly0Price_<?php echo $p; ?>" href="javascript:void(0);" class="monthly0Price <?php if($season_price_list[$p]['monthly_disc'] == 0 && $season_price_list[$p]['monthly_disc']!='' && $season_price_list[$p]['monthly_disc']!='M'){ echo 'active';} ?>">0</a></span>
						    </div>
						    <div class="pan2">
			    ...
			    <?php //pr($season_price_list); ?>
					...
					<?php } $p = $p-1;
					   ...
					   <!-- <tr><td>&nbsp;</td></tr>-->
						...
						<div class="col-sm-3 rentDailyPricePan">
						  <label for="reg_input_name" class="req">Daily Price</label>
						  <input value="" name="season_daily[]" type="text" class="form-controltwo required daily-price-fld" data-required="true" data-type="number" id="dailyprice_0">
						  <input name="disc_daily[]" type="hidden" id="dailydisc_0">
						...
						<div class="col-sm-3 rentWeeklyPricePan">
						  ...
						  <div id="weeklyPricePan_0" class="weeklyAutoPricePan">
							...
							<span><a id="weekly0Price_0" href="javascript:void(0);" class="weekly0Price">0</a></span>
						    </div>
						    <div class="pan2">
						...
						<div class="col-sm-3 rentMonthlyPricePan">
						  ...
						  <input value="" name="season_monthly[]" type="text" class="form-controltwo required" data-required="true" data-type="number" id="monthlyprice_0">
							...
							<span><a id="monthly0Price_0" href="javascript:void(0);" class="monthly0Price">0</a></span>
						    </div>
						    <div class="pan2">
