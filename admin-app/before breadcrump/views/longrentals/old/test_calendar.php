    ...
    <!-- Start : main content loads from here -->    
    	...
    	<div class="row">
			...
			<li><a id="property_rentals_div" class="property_menu">Property Rentals</a></li>
				...
				<div class="col-sm-12">
					...
					<br class="spacer" />	
                                        <div class="col-sm-12">
                                            ...
                                            <textarea name="direction_to_property" id="direction_to_property" class="form-control required" data-required="true"></textarea>
                                        </div>
					...
					<div class="col-sm-4">
						...
						<?php echo distance_from_arr(); ?>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input id="seo_title" name="seo_title" type="text" class="form-control required" data-required="true">
                                        </div>
                                       ...
                                       <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input id="meta_description" name="meta_description" type="text" class="form-control required" data-required="true">
                                        </div>
                ...
                <div id="property_rentals_fieldset" style="display:block;" class="property_tag_class">
				...
				<div class="col-sm-12">
					...
					{ 
					    ...
					    ?>
						<input name="rental_amenities[]" type="checkbox" value="<?php echo $prop_amenity_val['amenities_id'];?>" /><label><?php echo $prop_amenity_val['amenities_name'];?></label>
					    <?php
						} else { ?>
				...
				<div class="col-sm-12">
				    <div class="formPanSec">
					<div class="rightPan">
					    <div class="subHeading">Extra Services Offered</div>
					    <div class="subHeadingInput">
						<textarea class="form-control" name="property_amenity_text_rental"></textarea>
					    </div>
					</div>
				    </div>
				</div>
				...
				<div class="col-sm-12">
				  ...
				  <textarea name="cancellation_policy" id="cancellation_policy" data-required="true" class="form-control"></textarea>
				</div>
				<br class="spacer" />
				...
				<br class="spacer" />
				    ...
				    <input type="hidden" name="total_season_count" id="total_season_count" value="0" />
				    <br class="spacer" />  
				    <br class="spacer" />
				...
				<!--- SALES DIV --->
			    <div id="property_sales_fieldset" style="display:block;" class="property_tag_class">
				...
				<div class="col-sm-12">
				   ...
				   <!--<div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-controlone" data-type="number"  name="sales_price_from" id="sales_price_from" value="" data-required="true">
                    </div>
                   <div class="col-sm-3">
				...
				<div class="col-sm-12">
					...
					<?php foreach($sales_amenity as $prop_amenity_val) { 
						...
						<input name="sales_amenities[]" type="checkbox" value="<?php echo $prop_amenity_val['amenities_id'];?>" /><label><?php echo $prop_amenity_val['amenities_name'];?></label>
				...
				<h4 class="proHeadingText">Property Sale Description</h4>
                                <div class="col-sm-12">
                                    ...
                                    <texarea name="property_sales_desc" id="wysiwg_editor1" class="form-controlone"></texarea>
                                </div>
				<br class="spacer" />
                                ...
                                <div class="col-sm-3">
                                    <label for="bedroom_starting_from">Bedroom Starting From</label>
                                    <input id="bedroom_starting_from" name="bedroom_starting_from" type="text" class="form-control" value="">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label for="size_starting_from">Size Starting From</label>
                                    <input id="size_starting_from" name="size_starting_from" type="text" class="form-control" value="">
                                </div>
                                
                                <div class="col-sm-3">
                                    <label for="size_ending_to">Size Ending To</label>
                                    <input id="size_ending_to" name="size_ending_to" type="text" class="form-control" value="">
                                </div>
                ...
                <thead>
                  <tr>
                  	<th>&nbsp;</th>                 
                    <th>Building<span class="req"></span></th>
                    <th>Unit Number</th>
                    <th>Room Type</th>
                    <th>Size Sq (Total)</th>
                ...
                <tbody id="development_page_contain">
                	<tr id="development_sub_page_1" class="odd dev-pages" style="display:none;">
                        ...
                        <td><input type="text" name="dev_page_price[]" value="" class="form-control" /></td>
                    </tr>
...
$('.frm_step_next').click(function (e) {
	...
	$.ajax({
		...
		dataType: "HTML",
		url: submit_url,
		data: { form_data: frm_data, property_description:propertyDescription},
