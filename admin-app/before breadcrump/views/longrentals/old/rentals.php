...
<div id="main_content"> 
    ...
    <div class="col-sm-12">
      <div class="panel panel-default">
        ...
        <div class="panel_controls">
          <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property/rentals/">
            <div class="row">
              <div class="col-sm-4">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">Rental Property Listing
                ...
                if($propertyMasterList){			      
					for($i=0; $i<count($propertyMasterList); $i++){     
						...
						$statusLink	= str_replace("{{ID}}",$propertyMasterList[$i]['property_id'],$status_link);  
                                                $statusLink	= str_replace("{{STATUS_LINK}}",'edit_rental_property_status',$statusLink);  
