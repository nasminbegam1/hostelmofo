                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="portlet box portlet-green">
                            <div class="portlet-header">
                                <div class="caption">Sales Property location</div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <div id="rootwizard-custom-circle">
                                    ...
                                    <div class="tab-content">
                                        <form action="<?php echo BACKEND_URL.'property_sales/edit_map_location/'.$property_id.'/'.$page;?>" class="form-validate form-horizontal" enctype="multipart/form-data" method="post">
                                                ...
                                                <div class="portlet-header">
                                                    ...
                                                    <div class="portlet-body panel-body pan">
                                                            ...
                                                            <div class="form-body pal">
                                                                ...
                                                                <h4>Property Map Location <span style="float: right;"> <a href="javascript:void(0);" onclick="addMoreSeasons();"><i class="fa fa-plus-circle"></i> &nbsp;Override Another Location</a> </span></h4>
					...
					if(count($final_map_location) > 0){
						...
						<div class="col-md-3">
						    <br>
						    <legend>
							<a href="javascript:void(0);" onclick="removeSeason(<?php echo $count; ?>);" style=" float: right;"><h4> <i class="fa fa-minus-circle"></i> &nbsp; Remove Location</h4></a></legend>
						</div>
					...
					<input value="<?php echo $property_id;?>" name="prop_id" type="hidden" >
                                        ...
                                        <div class="action text-right">
                                            <button type="button" name="previous" onclick="javascript:go_to('<?php echo base_url().'property_sales/contact/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button>
