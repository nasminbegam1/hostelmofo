...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Sales Property List</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       <li><i class="glyphicon glyphicon-home"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Property</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="glyphicon glyphicon-home"></i>&nbsp;&nbsp;<a href="<?php echo $show_all;?>" >Sales Property List</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Sales Property Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property_sales/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
							...
							<?php  } ?>
                                                    ...
                                                    <td><?php echo stripslashes($propertyMasterList[$i]['property_sales_serial_no']);?></td>
...
<script type="text/javascript">
	...
	$(".changeStatusbtn").click(function(){
		...
		type: "POST",
		dataType: "HTML",
		url: "<?php echo BACKEND_URL; ?>" + "property_sales/edit_property_status/",
