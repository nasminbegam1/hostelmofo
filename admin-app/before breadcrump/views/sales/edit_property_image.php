...
<script type="text/javascript" src="<?php echo BACKEND_JS_PATH; ?>jquery.uploadfile.js"></script>
                                ...
                                <!--        TAB SECTION                    -->
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <div class="tools">
                                                        ...
                                                        <div class="portlet-body ">
                                                            ...
                                                            <div class="action action-top text-right">
                                                                <button type="button" name="previous" onclick="javascript:go_to('<?php echo base_url().'property_sales/edit_property/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button>
                                                                <button type="button" name="next" onclick="javascript:go_to('<?php echo base_url().'property_sales/floorplan_image/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Next" class="btn btn-info button-next mlm">Next<i class="fa fa-arrow-circle-o-right mlx"></i></button>
                                        ...
                                        <div class="action text-right">
                                            <button type="button" name="previous" onclick="javascript:go_to('<?php echo base_url().'property_sales/edit_property/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" value="Previous" class="btn btn-info button-previous"><i class="fa fa-arrow-circle-o-left mrx"></i>Previous</button>
                                            <button type="button" name="next" value="Next" onclick="javascript:go_to('<?php echo base_url().'property_sales/floorplan_image/'.$this->uri->segment(3,0).'/'.$this->uri->segment(4,0).'/' ?>');" class="btn btn-info button-next mlm">Next<i class="fa fa-arrow-circle-o-right mlx"></i></button>
                                        </div>
    ...
    $(document.body).on('click', '.delete_image', function(event){
        ...
        if (confirm("Are you sure, Do you want to delete this sales property?"))
        {
            ...
            $.ajax({
                    type: "POST",
                   dataType: "HTML",
                   url: backend_url + "property_sales/delete_property_image/",
    ...
    function add_image(property_id,display_image_name,is_feature){
        ...
        $.ajax({
                    type: "POST",
                    dataType: "HTML",
                    url: backend_url + "property_sales/add_property_image/",
    ...
    function update_image_data(property_image_id){
        ...
        $.ajax({
                type: "POST",
                dataType: "HTML",
                url: backend_url + "property_sales/update_image_data/",
    ...
    $(document.body).on('ifChecked', 'input', function(event){
       ...
       if (inputid!='') {
        ...
        $.ajax({
                type: "POST",
                dataType: "HTML",
                url: backend_url + "property_sales/set_feature_image/",
