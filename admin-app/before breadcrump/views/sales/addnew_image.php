    <div class="col-md-4 mix property_image <?php if($val['is_feature']=='Yes'){echo 'selected-feature-image';} ?>" style="display: inline-block;" >
            ...
            <div class="info">
                    <span class="form-element make-default-spn">
                        <label >
                            ...
                            <input type="radio" class="form-control make-featured "  name="make_featured[]" onclick="makefeature(this);" <?php if($val['is_feature']=='yes'){echo 'checked';} ?> id="featured-<?php echo $val['property_image_id'];?>" />
                    ...
                    <span class="form-element">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="image_caption[]" class="form-control form-input" id="caption-<?php echo $val['property_image_id'];?>" />
                        </div>
                    </span>
                    ...
                    <span class="form-element">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="image_alt[]" class="form-control form-input" id="alt-<?php echo $val['property_image_id'];?>" />
                        </div>
                    </span>
                    ...
                    <span class="form-element">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="image_order[]" value="<?php echo $val['image_order'];?>" class="form-control form-input" id="order-<?php echo $val['property_image_id'];?>" />
                        </div>
                    </span>
