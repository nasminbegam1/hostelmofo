    ...
    margin-left: 2% !important;
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Add Sales Property</div>
                </div>
                            ...
                            <div class="portlet-body">
                                <div id="rootwizard-custom-circle">
                                    ...
                                    <div class="tab-content">
                                        <form action="<?php echo BACKEND_URL;?>property_sales/add_property/" class="form-validate form-horizontal" enctype="multipart/form-data" method="post">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <label class="radio-inline"><input type="radio" <?php echo set_radio('off_plan',"No")?> name="off_plan" id="off_plan" value="No"/>&nbsp;
                                                                                    Not Completed</label><label class="radio-inline"><input type="radio" <?php echo set_radio('off_plan',"Yes",true)?>  name="off_plan" id="off_plan" value="Yes"/>&nbsp;
                                                                                    Completed</label>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <label class="radio-inline"><input type="radio" name="furnished" id="furnished_yes" value="Yes" <?php echo set_radio('furnished',"Yes")?>/>&nbsp;
                                                                                    Yes</label>
                                                                                <label class="radio-inline"><input type="radio" name="furnished" id="furnished_no" value="No" <?php echo set_radio('furnished',"No",true)?>/>&nbsp;
                                                                                    No</label>
                                                                                <label class="radio-inline"><input type="radio" name="furnished" id="furnished_part" value="Part" <?php echo set_radio('furnished',"Part")?>/>&nbsp;
                                                                                    Part</label>
                                                                            </div>
                                                                        </div>
                                                                 ...
                                                                 <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="500m" <?php echo set_radio('distance_from_beach',"500m")?>/>&nbsp;
                                                                                    500M</label>
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="beachfront" <?php echo set_radio('distance_from_beach',"beachfront")?>/>&nbsp;
                                                                                    Beachfront</label>
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="golfview" <?php echo set_radio('distance_from_beach',"golfview")?>/>&nbsp;
                                                                                    Golf View</label>
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="marina" <?php echo set_radio('distance_from_beach',"marina")?>/>&nbsp;
                                                                                    Marina</label>
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="oceanfront" <?php echo set_radio('distance_from_beach',"oceanfront")?>/>&nbsp;
                                                                                    Ocean Front</label>
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="seaview" <?php echo set_radio('distance_from_beach',"seaview")?>/>&nbsp;
                                                                                    Seaview</label>
                                                                                <label class="radio-inline"><input type="radio" name="sales_beach_distance"  value="NA" <?php echo set_radio('distance_from_beach',"NA",true);?>/>&nbsp;
                                                                                    NA</label>
                                                                            </div>
                                                                        </div>
                                                                 ...
                                                                 <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            ...
                                                                            <textarea name="property_description"  class="ckeditor form-control"><?php echo set_value('property_description');?></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                </div>
                                                            ...
                                                            <div class="form-body pal">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-7 input-icon">
                                                                           ...
                                                                           <input data-type="number"  name="sales_price_from" id="sales_price_from" type="text"  class="form-control number required" value="<?php echo set_value('sales_price_from');?>"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <label class="radio-inline"><input type="radio" name="hold_type" value="Leasehold" <?php echo set_radio('freehold_leasehold','Leasehold'); ?>/>&nbsp;
                                                                                    Leasehold</label><label class="radio-inline"><input type="radio" name="hold_type" value="Freehold" <?php echo set_radio('freehold_leasehold','Freehold',true); ?>/>&nbsp;
                                                                                    Freehold</label>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-7 input-icon">
                                                                           ...
                                                                           <input id="freehold_leasehold_text" name="freehold_leasehold_text" type="text"  class="form-control" value="<?php echo set_value('freehold_leasehold_text'); ?>"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-7 input-icon">
                                                                           ...
                                                                           <input id="size_starting_from" name="size_starting_from" data-type="number" type="text"  class="form-control number required" value="<?php echo set_value('size_starting_from'); ?>"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-7 input-icon">
                                                                            <i class="fa fa-superscript"></i>
                                                                           <input id="size_ending_to" data-type="number" name="size_ending_to" type="text"  class="form-control number required" value="<?php echo set_value('size_ending_to'); ?>"/>
                                                                 ...
                                                                 <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            ...
                                                                            <textarea  name="sales_payment_info"   class="ckeditor form-control"><?php echo set_value('property_description');?></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                </div>
						     ...
						     <div class="col-md-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="sales_amenities[<?php echo $prop_amenity_val['amenities_id'];?>]" data-style="btn-white"  data-show-subtext="true" class="amenity_class form-control">
