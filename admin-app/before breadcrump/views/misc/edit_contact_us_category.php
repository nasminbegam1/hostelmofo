...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Edit contact us category</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
        <li><i class="fa fa-location-arrow"></i>&nbsp;&nbsp;<a href="javascript:void(0)">
Contact us category</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-location-arrow"></i>&nbsp;&nbsp;<a href="<?php echo $edit_link; ?>" >
Edit contact us category</a></li>
         ...
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-yellow">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Edit contact us category</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
							...
							<div class="form-group"><label for="country_code" class="col-md-3 control-label">Contact us category name<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control required" name="contact_us_category_name" id="contact_us_category_name" value="<?php echo stripslashes($contact_us_category['category_name']); ?>">
                                                            </div>
                                                        </div>
