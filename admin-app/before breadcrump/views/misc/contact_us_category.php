...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Contact Us Category Master</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-location-arrow"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Contact Us Category</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><a href="<?php echo $show_all;?>" ><i class="fa fa-location-arrow"></i>&nbsp;Listing</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Contact Us Category Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>misc/contact_us_category/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                <thead>
                                                 <tr>
                                                    ...
                                                    <th data-toggle="true">Conatct Us Category Name</th>
                                                ...
                                                <tbody>
                                               <?php 
                            if($contactUsCategoryList){
                            for($i=0; $i<count($contactUsCategoryList); $i++){                                
								$editLink = str_replace("{{ID}}",$contactUsCategoryList[$i]['category_id'],$edit_link); 
								$deleteLink = str_replace("{{ID}}",$contactUsCategoryList[$i]['category_id'],$delete_link);  
								$class = 'class="even"';
 								if($i%2==0)
									$class = 'class="even"';
								else
                        ...
                        ?>
                        <tr <?php echo $class; ?>>
                          	<td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $contactUsCategoryList[$i]['category_id'];?>" /></td>
                            <td><?php echo stripslashes($contactUsCategoryList[$i]['category_name']);?></td>
                            <td><?php echo ucfirst(stripslashes($contactUsCategoryList[$i]['category_status']));?></td>
