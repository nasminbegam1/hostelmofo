...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right">
       ...
       <li><i class="fa fa-picture-o"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Banner</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-picture-o"></i>&nbsp;&nbsp;<a href="<?php echo $show_all;?>" >Banner Listing</a></li>
                                        ...
                                        <div class="table-container">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($bannerList[$i]['banner_link']);?></td>
