...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right">
        ...
        <li class="active"><i class="fa fa-picture-o"></i>&nbsp;&nbsp;<a href="<?php echo $add_url;?>" >Add New Banner</a></li>
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="banner_image" class="col-md-3 control-label">Banner Image<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                               <input type="file" name="banner_image" required name="banner_image" id="banner_image" />&nbsp;<strong>[image size maximum 1600x655 | extension must be .jpg or .jpeg or .gif or .png]</strong>
                                                            </div>
                                                        </div>
