...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Edit SEO Sales Landing Page Text</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
        <!--<li><i class="fa fa-picture-o"></i>&nbsp;&nbsp;<a href="javascript:void(0)">CMS</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>-->
        <li class="active">&nbsp;&nbsp;<a href="avacript:void()" ><i class="fa fa-info-circle"></i> &nbsp;SEO Sales Landing Pages&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</a></li>
        <li class="active">&nbsp;&nbsp;<a href="" >Edit Page Text</a></li>
    </ol>
				  ...
				  <form method="post" action="" class="form-validate form-horizontal form-seperated " enctype="multipart/form-data" id="add_form">
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Edit SEO Sales Landing Location</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
						 <input type="hidden" readonly class="form-control " name="type" id="property_name" value="<?php echo $this->uri->segment(3);?>" > 
							    ...
							    <label for="type_id" class="col-md-3 control-label">Select Location</label>

                                                            <div class="col-md-6">
                                                              <input type="text" readonly class="form-control " name="url" id="property_name" value="<?php echo strtoupper(stripslashes($landing_page_data['type'])); if(!empty($type_name)){echo ' ('.$type_name .')'; } ?>" >
                                                            </div>
                                                        </div>
							
							<div class="form-group">
							    <label for="name" class="col-md-3 control-label">H1 Tag</label>
                                                            <div class="col-md-6">
								  <input type="text"  class="form-control " data-required="true" name="name" id="property_name" value="<?php echo stripslashes($landing_page_data['name']);?>" >
                                                            </div>
                                                        </div>
							<div class="form-group">
							    <label for="page_title" class="col-md-3 control-label">Page Title</label>
                                                            <div class="col-md-6">
								  <input type="text"  class="form-control " name="page_title"  value="<?php echo stripslashes($landing_page_data['page_title']);?>" data-required="true">
                                                            </div>
                                                        </div>
							<div class="form-group">
							...
							<div class="form-group">
							    <label for="page_title" class="col-md-3 control-label">Content Text</label>
                                                            <div class="col-md-9">
								  <textarea   class="ckeditor form-control" name="content" ><?php echo stripslashes($landing_page_data['content']);?></textarea>
                                                            </div>
                                                        </div>
