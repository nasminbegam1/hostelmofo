...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">As Featured In Pages</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       <li><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Feature</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;<a href="<?php echo $show_all;?>" >Featured Listing</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Feature Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>feature/listview/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">As Featured In Title</th>
                                                    <th width="10%">As Featured In Link</th>
                                                ...
                                                for($i=0; $i<count($clientList); $i++)
                                                {
                                                 ...
                                                 $editLink	= str_replace("{{ID}}",$clientList[$i]['client_id'],$edit_link);
                                                $deleteLink	= str_replace("{{ID}}",$clientList[$i]['client_id'],$delete_link);
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($clientList[$i]['client_title']);?></td>
                                                    <td><?php echo stripslashes($clientList[$i]['client_link']);?></td>
...
<script>
  ...
  function searchValidation()
  {
    ...
    {
       alert("Search Field Must Contain Title Or Link");
