...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right">
        ...
        <li class="active"><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="<?php echo $add_url;?>" >Add Agent User</a></li>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-green">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Agent User Form</div>
                                                    <div class="tools">
                                                        ...
                                                        <div class="form-group"><label for="inputPhoneNo" class="col-md-3 control-label">Phone Number</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-icon"><i class="fa fa-phone-square"></i>
                                                                    <input name="phone_no" type="text" placeholder="Phone Number" class="form-control phone_no" id="phone_no" value="<?php echo set_value('phone_no'); ?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group"><label for="inputSkypeId" class="col-md-3 control-label">Skype Id</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-icon"><i class="fa fa-skype"></i>
                                                                    <input name="skype_id" type="text" placeholder="Skype Id" class="form-control skype_id" id="skype_id" value="<?php echo set_value('skype_id'); ?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
