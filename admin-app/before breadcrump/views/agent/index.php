...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right">
       ...
       <li><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Agent</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="<?php echo $show_all;?>" >Agent Listing</a></li>
                ...
                <div id="table-action" class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Agent User Search Panel</h4>
                                        ...
                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>agent/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                for($i=0; $i<count($userList); $i++)
                                                {
                                                 ...
                                                 $editLink = str_replace("{{ID}}",$userList[$i]['admin_id'],$edit_link);
                                                 $deleteLink = str_replace("{{ID}}",$userList[$i]['admin_id'],$delete_link);   
                                                $db_user_image  = stripslashes($userList[$i]['image']);
                                                if($db_user_image!='')
                                                {
                                                    if(file_exists(FILE_UPLOAD_ABSOLUTE_PATH.'admin/'.$db_user_image) && $db_user_image != "")
                                                    {
                                                        $user_image = FILE_UPLOAD_URL."admin/".$userList[$i]['image'];
                                                    }
                                                    else
                                                    {
                                                ...
                                                ?>  
                                                <tr>
                                                    <td><input type="checkbox" name="page[]" value="<?php echo $userList[$i]['admin_id'];?>"/></td>
                                                    
                                                    <td style="text-align:center" ><img src="<?php echo $user_image;?>" border="0" width="100" height="100"></td>
                                                    <td><?php echo stripslashes($userList[$i]['first_name']);?></td>
                                                    <td><?php echo stripslashes($userList[$i]['last_name']);?></td>
                                                    <td><?php echo stripslashes($userList[$i]['email_id']);?></td>
							...
							{
							  if($session_user_id != $userList[$i]['admin_id'])
							{
