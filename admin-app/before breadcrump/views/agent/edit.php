...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Edit Agent User</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
        <li><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="javascript:void(0)">User</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="<?php echo $edit_link;?>" >Agent User Edit</a></li>
        ...
        <div class="col-lg-12">
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
					    ...
					    <div class="portlet-header">
                                                    <div class="caption">Agent User Edit Form</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="inputPhoneNo" class="col-md-3 control-label">Phone Number</label>

                                                            <div class="col-md-4">
                                                                <div class="input-icon"><i class="fa fa-phone-square"></i>
                                                                    <input name="phone_no" type="text" placeholder="Phone Number" class="form-control" id="phone_no" value="<?php echo stripslashes($user_info[0]['phone_no']); ?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        
                                                        <div class="form-group"><label for="inputSkypeId" class="col-md-3 control-label">Skype Id</label>

                                                            <div class="col-md-4">
                                                                <div class="input-icon"><i class="fa fa-skype"></i>
                                                                    <input name="skype_id" type="text" placeholder="Skype Id" class="form-control" id="skype_id" value="<?php echo stripslashes($user_info[0]['skype_id']); ?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
