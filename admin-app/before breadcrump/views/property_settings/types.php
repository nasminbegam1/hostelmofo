...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Property Type Master</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-building-o"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Property Type Master</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
...
<!--BEGIN CONTENT-->
            ...
            <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Property Types Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property_settings/types/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
				...
				$deleteLink	= str_replace("{{ID}}",$propertyTypeList[$i]['property_type_id'],$delete_link);
                                $db_user_image  = stripslashes($propertyTypeList[$i]['property_type_id']);
                                $class = 'class="even"';
 				if($i%2==0)
				  $class = 'class="even"';
				else
				  $class = 'class="odd"';
                        ?>
                        <tr <?php echo $class; ?>>
                          <td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $propertyTypeList[$i]['property_type_id'];?>" /></td>
                          <td><?php echo stripslashes($propertyTypeList[$i]['property_name']);?></td>
                          <td><?php echo ucfirst(stripslashes($propertyTypeList[$i]['property_status']));?></td>
                          <td> N/A
