...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">VA Users Listing</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
        
        <li><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="javascript:void(0)">User</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-user"></i>&nbsp;&nbsp;<a href="<?php echo $show_all;?>" >VA User Listing</a></li>
   ...
   <!-- <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Left Sidebar</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">VA User Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>va_user/vauser/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button type="submit" onclick=" return searchValidation();" class="btn btn-success">Search</button>
                                                    </span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."va_user/batch_action/0/".$page;?>" method="post">
