...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Add New File</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
        <li><i class="fa fa-upload"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Image Upload</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-picture-o"></i>&nbsp;&nbsp;<a href="<?php echo $add_url;?>" >Add New Image</a></li>
...
<!--BEGIN CONTENT-->
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-pink">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Add New Image</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="file_name" class="col-md-3 control-label">Image<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                               <input type="file" name="file_name" required name="file_name" id="file_name" />
                                                            </div>
                                                        </div>
   ...
   <!--<div style="height: 500px;border:1px solid;"></div>    -->   
<script>
