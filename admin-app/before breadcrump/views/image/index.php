...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Image Listing</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       <li><i class="fa fa-upload"></i>&nbsp;&nbsp;<a href="javascript:void(0)">Image</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active"><i class="fa fa-upload"></i>&nbsp;&nbsp;<a href="<?php echo $show_all;?>" >Image Listing</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 class="box-heading">Image Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>image/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                $editLink	= str_replace("{{ID}}",$fileList[$i]['id'],$edit_link);
                                                $deleteLink	= str_replace("{{ID}}",$fileList[$i]['id'],$delete_link);
                                                $db_user_image  = stripslashes($fileList[$i]['id']);
                                                $class = 'class="even"';
                                                if($i%2==0)
                                                  $class = 'class="even"';
                                                else
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><input type="checkbox" name="page[]" class="checkItem" value="<?php echo $fileList[$i]['id'];?>" /></td>
                                                    <td><?php echo stripslashes($fileList[$i]['original_file_name']);?></td>
                                                    <td><a href="<?php echo stripslashes($fileList[$i]['upload_path']);?>" target="_blank"><?php echo stripslashes($fileList[$i]['upload_path']);?></a></td>
