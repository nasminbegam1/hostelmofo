...
Property Map Location</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right">
       
       
        <li><i class="fa fa-map-marker"></i>&nbsp;&nbsp;<a href="javascript:void(0)">
Property Map Location</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
...
<!--BEGIN CONTENT-->
            ...
            <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Property Map Location Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>map_location/property_map_location/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                <thead>
                                                <tr>
                                                    <th data-toggle="true" style="width:10%;">Place Name</th>
                                                    <th data-toggle="true" style="width:10%;">Latitude</th>
                                                    <th data-toggle="true" style="width:10%;">Longitude</th>				
                                                    <th data-toggle="true" style="width:10%;">Place Type</th>
                                                    <th data-toggle="true" style="width:10%;">Associate Location</th>
                                                    <th style="width:10%;">Add Date</th>
                                                    <th data-toggle="true" style="width:10%;">Status</th>
			   ...
			   <?php 
                            if($propertyMapList){
                            for($i=0; $i<count($propertyMapList); $i++){                                
                                $editLink	= str_replace("{{ID}}",$propertyMapList[$i]['id'],$edit_link);
				$deleteLink	= str_replace("{{ID}}",$propertyMapList[$i]['id'],$delete_link);
                                $class = 'class="even"';
 				if($i%2==0)
				  $class = 'class="even"';
				else
				  $class = 'class="odd"';
                        ...
                        <tr <?php echo $class; ?>>
                          ...
                          <td><?php echo ucfirst(stripslashes($propertyMapList[$i]['location_name']));?></td>
                          <td><?php echo stripslashes($propertyMapList[$i]['latitude']);?></td>
			  <td><?php echo stripslashes($propertyMapList[$i]['longitude']);?></td>
			  <td><?php if($propertyMapList[$i]['location_type'] == 'important_serveices')echo "Important Services";else echo ucfirst(stripslashes($propertyMapList[$i]['location_type']));?></td>
			  <td><?php
			  if($propertyMapList[$i]['beach_location'] != '')
			    echo $propertyMapList[$i]['beach_location'];
			  else
			    echo "N/A";
			  ?></td>
			  <td><?php echo $propertyMapList[$i]['add_date'];?></td>
			  <td><?php echo $propertyMapList[$i]['status'];?></td>
