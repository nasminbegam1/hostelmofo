				...
				if(file_exists($_FILES['banner_image']['tmp_name']))
				{
				 ...
				 if($new_file_name!='')
				 {
					 $config 	= array(
							     ...
							     'new_image'	=> FILE_UPLOAD_ABSOLUTE_PATH.'banner/'.$new_file_name
							 );
					 
					 $this->image_lib->initialize($config);
					 $this->image_lib->resize();
					 
					 $file = FRONTEND_URL.'upload/banner/'.$new_file_name;
					 $this->cdnupload->upload($file,'banner/',$new_file_name);
					 @unlink(FILE_UPLOAD_ABSOLUTE_PATH.'banner/'.$new_file_name);
					 ...
					 $config 	= array(
							     'image_library' 	=> 'GD2',
							     'source_image'	=> $tmp_name,
							     'new_image'	=> FILE_UPLOAD_ABSOLUTE_PATH.'banner/thumb/'.$new_file_name,
							     'create_thumb'	=> true,
							     'width'		=> '1680',
							     'height'		=> '773'
					 ...
					 $file = FRONTEND_URL.'upload/banner/thumb/'.$new_file_name;
					 $this->cdnupload->upload($file,'banner/thumb',$new_file_name);
					 @unlink(FILE_UPLOAD_ABSOLUTE_PATH.'banner/thumb/'.$new_file_name);
...
//                                $thumb_config['thumb_height']                           = '773';
				 ...
				 //$banner_image	        = ((!$new_file_name) ? '' : $new_file_name);
                                ...
                                $isUploaded 		= ($_FILES['banner_image']['name']!='') ? $new_file_name : '' ;
				...
				// if(($_FILES['banner_image']['name']!='') && stripslashes($banner_image_old) != "")
				// {
				//	 @unlink(CDN_BANNER_IMG.stripslashes($banner_image_old));
				//	 @unlink(CDN_BANNER_THUMB_IMG.stripslashes($banner_image_old));
				// }
