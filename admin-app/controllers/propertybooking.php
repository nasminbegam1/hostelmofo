...
class Propertybooking extends My_Controller
{
	...
	public function bookings()
	{
		...
		$config['base_url'] 	= BACKEND_URL."propertybooking/bookings/".$property_id."/";
		$config['per_page'] 	= 50;
		...
		$this->data['base_url'] 		= BACKEND_URL."propertybooking/bookings/".$property_id."/";
		$this->data['view_link']      		= BACKEND_URL."propertybooking/view/{{ID}}/".$page."/";		
		$this->data['delete_link']     		= BACKEND_URL."propertybooking/delete/{{ID}}/".$page."/";
		$this->data['cancel_link']     		= BACKEND_URL."propertybooking/cancel_booking/".$property_id."/{{ID}}/".$page."/";
	...
	public function cancelled()
	{
		...
		$config['base_url'] 	= BACKEND_URL."propertybooking/cancelled/".$property_id.'/';
		$config['per_page'] 	= 50;
		$config['uri_segment']	= 4;
		$config['num_links'] 	= 20;
		$this->pagination->setAdminPaginationStyle($config);
		...
		$this->data['page']	 		= $page;
		$this->data['controller'] 		= 'enquiry';	
		$this->data['base_url'] 		= BACKEND_URL."propertybooking/cancelled/".$property_id.'/';
		$this->data['view_link']      		= BACKEND_URL."propertybooking/view/{{ID}}/".$page."/";		
		$this->data['delete_link']     		= BACKEND_URL."propertybooking/delete/{{ID}}/".$page."/";
	...
	public function arrival()
	{
		...
		$config['base_url'] 	= BACKEND_URL."propertybooking/arrival/".$property_id.'/';
		$config['per_page'] 	= 50;
		$config['uri_segment']	= 4;
		$config['num_links'] 	= 20;
		$this->pagination->setAdminPaginationStyle($config);
		...
		$this->data['page']	 		= $page;
		$this->data['controller'] 		= 'enquiry';	
		$this->data['base_url'] 		= BACKEND_URL."propertybooking/arrival/".$property_id.'/';
		$this->data['view_link']      		= BACKEND_URL."propertybooking/view/{{ID}}/".$page."/";		
		$this->data['delete_link']     		= BACKEND_URL."propertybooking/delete/{{ID}}/".$page."/";
	...
	public function cancel_booking()
	{
		...
		$redirect_url = BACKEND_URL."propertybooking/bookings/".$property_id."/".$page;
