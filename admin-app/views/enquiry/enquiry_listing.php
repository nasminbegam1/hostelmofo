...
<!--BEGIN CONTENT-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 >Enquiry Search Panel</h4>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Enquiry Listing 
				...
				<th style="width: 15%;" data-toggle="true">Property Name</th>
			  ...
			  $pos = stripos($notes, "wdc");
			    ...
			    <td>
			      ...
			      <a href="<?php echo FRONTEND_URL.'property-rent/'.$enquiryList[$i]['property_slug'].'/'; ?>" target="_blank">
				<?php echo stripslashes($enquiryList[$i]['property_name'])?>
			      </a>
			      <?php } else { echo 'N.A.'; }?>
			    </td>
			    
			    <td><?php echo @date("d/m/Y H:i:s", strtotime($enquiryList[$i]['updated_on']));?>
			    <?php //echo date("Y-m-d H:i:s",mktime($add_date5[0],$add_date5[1],$add_date5[2],$add_date4[1],$add_date4[2],$add_date4[0])+7*3600); ?>
			    </td>
                            <td>
				...
				<i class="glyphicon glyphicon-eye-open"></i>
			      ...
			      <?php if($this->nsession->userdata('role') == 'agent') { if($enquiryList[$i]['assigned_user'] == 1) {?>		      
			     <!-- <a class="various3 previewLinkBtn changeStatus" href="<?php echo $leadLink;?>">
                                <span class=" property_list property_list_preview">Lead</span>
                              </a>-->
                             <?php } } else if($this->nsession->userdata('role') == 'admin') { ?>			     
			     <!-- <a class="various3 previewLinkBtn changeStatus" href="<?php echo $leadLink;?>">
                                <span class=" property_list property_list_preview">Lead</span>
                              </a>-->
