...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Hear About Listing</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Hear About Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>hear_about/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."hear_about/batch_action/0/".$page;?>" method="post">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">Hear About Name</th>
                                                ...
                                                if(is_array($hearAboutList))
                                                {
                                                for($i=0; $i<count($hearAboutList); $i++)
                                                {
                                                    
                                                 $editLink	= str_replace("{{ID}}",$hearAboutList[$i]['hear_about_id'],$edit_link);
                                         $deleteLink	= str_replace("{{ID}}",$hearAboutList[$i]['hear_about_id'],$delete_link);
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($hearAboutList[$i]['hear_about_name']);?></td>
                                                    
                                                    
                                                    <td style="text-align: center;">
						    <?php
							if($hearAboutList[$i]['status']=='Active')
							{
							?>
							<label onclick="javascript:statusModifier('hear_about',this)" data-team='<?php echo $hearAboutList[$i]['hear_about_id']; ?>' class="btn btn-success" title="Active" >
							<i class="fa fa-check-square-o"></i>
							</label>
							
							<?php
							}
							else if($hearAboutList[$i]['status']=='Inactive')
							{
							?>
							<label onclick="javascript:statusModifier('hear_about',this)" data-team='<?php echo $hearAboutList[$i]['hear_about_id']; ?>' class="btn btn-primary" title="Inactive">
						    ...
						    ?>
                                                    ...
                                                    <img class="loader" id="loader_<?php echo $hearAboutList[$i]['hear_about_id']; ?>" src="<?php echo BACKEND_URL."vendors/pageloader/images/loader7.GIF" ?>" style="width:25px;" /> 
                                                    </td>
                                                </tr>
                                                <?php } } else {  ?>
