                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Edit Discount Code </div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="code" class="col-md-3 control-label">Discount Code<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="code" type="text" placeholder="" class="form-control required" id="code" value="<?php echo $record['code']; ?>"/>
                                                        ...
                                                        <div class="form-group"><label for="amount_percent" class="col-md-3 control-label">Amount/Percentage<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="amount_percent" type="text" placeholder="" class="form-control required digits" id="amount_percent" value="<?php echo $record['amount_percent']; ?>"/>
							...
							<div class="form-group"><label for="type" class="col-md-3 control-label">Discount Type<span class='require'>*</span></label>
								    ...
								    <option value="">Select</option>
                                                                    <option value="Fixed" <?php echo($record['type']=='Fixed'? 'selected':'') ?>>Fixed</option>
                                                                    <option value="Percentage" <?php echo($record['type']=='Percentage'? 'selected':'') ?>>Percentage</option>
                                                                </select>
                                                            </div>
                                                        </div>
						    ...
						    <div class="form-group"><label for="property_type_ids" class="col-sm-3 control-label">Property Type<span class='require'>*</span></label>
								...
								<div class="input-group">
								    ...
								    <div class="col-sm-4">
								    <input type="checkbox" name="property_type_ids[]" class="propPropertyType requiredInput" value="<?php echo $list['property_type_id'] ?>" <?php echo ($record['property_type_ids']!=''? (in_array($list['property_type_id'], explode(',',$record['property_type_ids']))? 'checked="checked"':''):'') ?>/> &nbsp;<?php echo $list['property_type_name'] ?></div>
								    <?php $flg=1; } } ?>
								    <i class="alert alert-hide pType">Oops, Select at Least one Property Type</i>
								</div>
...
<!--						    <div class="form-group"><label for="room_type_ids" class="col-sm-3 control-label">Room Type<span class='require'>*</span></label>
								...
								<div class="input-group">
								    ...
								    <div class="col-sm-4">
								    <input type="checkbox" name="room_type_ids[]" class="propRomeType requiredInput" value="<?php echo $room['roomtype_id'] ?>" <?php echo ($record['room_type_ids']!=''? (in_array($room['roomtype_id'], explode(',',$record['room_type_ids']))? 'checked="checked"':''):'') ?>/> &nbsp;<?php echo $room['roomtype_name'] ?></div>
								    <?php $flg=1;} } ?>
...
-->							
                                                    ...
                                                    <div class="form-actions text-right pal">
                                                        <button type="button" id="submitBtn" class="btn btn-primary">Edit Discount Code </button>
                                                        &nbsp;
	...
	//    }	    
	    ...
	    if (!$('.propPropertyType').is(':not(:checked)')){
		$('#property_type_all').prop('checked', true);
	    }
	    
	//    if (!$('.propRomeType').is(':not(:checked)')){
	//	$('#room_type_all').prop('checked', true);
	//    }	    
