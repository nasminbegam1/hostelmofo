                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Discount Code Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>discountcode/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."discountcode/batch_action/0/".$page;?>" method="post">
					    ...
					    <div id="no-more-tables">
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                $editLink	= str_replace("{{ID}}",$records[$i]['code_id'],$edit_link);
                                                $deleteLink	= str_replace("{{ID}}",$records[$i]['code_id'],$delete_link);
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td data-title="Code"><?php echo stripslashes($records[$i]['code']);?></td>
                                                    <td data-title="Status"><?php echo stripslashes($records[$i]['status']);?></td>
                                                    <td style="text-align: center;" data-title="Actions">
						    <?php
							if($records[$i]['status']=='Active')
							{
							?>
							<label onclick="javascript:statusModifier('discountcode',this)" data-team='<?php echo $records[$i]['code_id']; ?>' class="btn btn-success" title="Active"  >
							<i class="fa fa-check-square-o"></i>
							</label>
							
							<?php
							}
							else if($records[$i]['status']=='Inactive')
							{
							?>
							<label onclick="javascript:statusModifier('discountcode',this)" data-team='<?php echo $records[$i]['code_id']; ?>' class="btn btn-primary"  title="Inactive" >
						    ...
						    ?>
                                                    ...
                                                    <img class="loader" id="loader_<?php echo $records[$i]['code_id']; ?>" src="<?php echo BACKEND_URL."vendors/pageloader/images/loader7.GIF" ?>" style="width:25px;" /> 
                                                    </td>
                                                </tr>
                                                <?php } } else {  ?>
