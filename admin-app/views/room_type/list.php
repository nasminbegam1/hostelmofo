...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Room Type Listing</div>
    </div>
 <!--For breadcrump-->    
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">Room Type</th>
																										<th width="10%">Bathroom Option</th>
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td data-title="Room Type">
																	 <?php if($roomTypeList[$i]['room_price_type'] == 'per_person') echo stripslashes("Per Person");
																	        else echo stripslashes("Per Night"); ?>
																	 </td>
																										<td data-title="Bathroom Option"><?php echo stripslashes(str_replace("_"," ",$roomTypeList[$i]['bathroom_option']));?></td>
