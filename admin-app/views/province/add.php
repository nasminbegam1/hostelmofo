...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Add New Provines</div>
    </div>
 <!--For breadcrump-->    
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Add New Province</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="province_name" class="col-md-3 control-label">Province Name<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="province_name" type="text" placeholder="" class="form-control required" id="province_name" value="<?php echo set_value('province_name'); ?>"/>
