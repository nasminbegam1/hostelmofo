...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Newsletter Listing</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Newsletter Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>news_letter/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
					    ...
					    <div id="no-more-tables">
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                if(is_array($newsletter_list) && count($newsletter_list > 0))
                                                {
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td data-title="Name"><?php echo stripslashes($newsletter_list[$i]['first_name']);?></td>
                                                    
                                                    <td data-title="Email"><?php echo stripslashes($newsletter_list[$i]['email']);?></td>
                                                    
                                                    <td data-title="Date"><?php echo date("d/m/Y H:i:s", strtotime($newsletter_list[$i]['date_added']));?></td>
                                                </tr>
                                                <?php } } else {  ?>
