						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        <div class="form-group"><label for="inputFirstName" class="col-md-3 control-label">Setting Label</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <input name="" type="text" placeholder="Setting Label" class="form-control required setting_label" id="setting_label" value="<?php echo $sitesettings_lebel;?>" disabled="disabled"/>
                                                        ...
                                                        <div class="form-group"><label for="inputLastName" class="col-md-3 control-label">Setting Value <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <?php
								if($sitesettings_id == '22'){
								?>
								<select class="form-control" data-required="true" name="sitesettings_value">
								<?php for($i=10;$i<=20;$i++){?>
								<option value="<?php echo $i; ?>" <?php echo ($i==$sitesettings_value)?'selected':'';?>><?php echo $i; ?></option>
								<?php } ?>
								</select>
								<?php
								}
