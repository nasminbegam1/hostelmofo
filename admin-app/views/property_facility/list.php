...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Property Facilities</div>
    </div>
   <!--For breadcrump-->    
...
<!--BEGIN CONTENT-->
            ...
            <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Property Facilities Search Panel</h4>
						...
						<th data-toggle="true">Facility Name</th>
			  ...
			  //if ($amenityList[$i]['amenities_filter'] == 1){
			    ?>
			  <select  name="apply_action" id="<?php echo $amenityList[$i]['amenities_id']; ?>"  class="form-control setval_change" >
                                                <?php
			 ...
			 // }else{echo "N/A";}
			  ?></td>
			    ...
			    <?php
				if($amenityList[$i]['amenities_status']=='active')
				{
				?>
				<label onclick="javascript:statusModifier('facility',this)" data-team='<?php echo $amenityList[$i]['amenities_id']; ?>' class="btn btn-success"  title="<?php echo ucfirst($amenityList[$i]['amenities_status']); ?>">
				<i class="fa fa-check-square-o"></i>
				</label>
				
				<?php
				}
				else if($amenityList[$i]['amenities_status']=='inactive')
				{
				?>
				<label onclick="javascript:statusModifier('facility',this)" data-team='<?php echo $amenityList[$i]['amenities_id']; ?>' class="btn btn-primary" title="<?php echo ucfirst($amenityList[$i]['amenities_status']); ?>" >
			    ...
			    ?>
                            ...
                            <a href="<?php echo $deleteLink;?>" class="tablectrl_small bDefault tipS" title="Delete" onclick="return confirm('Are you sure?');">
                             ...
                             <img class="statusLoader loader" id="loader_<?php echo $amenityList[$i]['amenities_id']; ?>" src="<?php echo BACKEND_URL."vendors/pageloader/images/loader7.GIF" ?>" /> 
                          </td>
                        </tr>
                        <?php } } else {  ?>
