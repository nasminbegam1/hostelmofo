         ...
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
						...
						<input type="hidden" name="action" value="Process">
							...
							<div class="form-group"><label for="property_description" class="col-md-3 control-label">Property Description</label>
                                                            ...
                                                            <div class="col-md-9">
                                                               <textarea name="property_description" class="ckeditor form-control" style="height: 300px;"><?php echo set_value('property_description');?></textarea>
                                                            </div>
                                                        </div>
							...
							<div class="form-group"><label for="meta_title" class="col-md-3 control-label">Meta Title</label>
							       ...
							       <span id="countexact_meta_title">0</span><span>/69</span>
                                                        ...
                                                        <div class="form-group"><label for="meta_key" class="col-md-3 control-label">Meta Keyword</label>
                                                            ...
                                                            <div class="col-md-9">
                                                               <textarea name="meta_key" id="meta_key" class="form-control"><?php echo set_value('meta_key');?></textarea>
							...
							<div class="col-sm-9">
								...
								<div class="col-sm-4">
								<input type="checkbox" name="city_name[]" class="propRomeType" value="<?php echo $city['city_master_id'] ?>" /> &nbsp;<?php echo $city['city_name'] ?></div>
								<?php } } ?>
							    </div>
