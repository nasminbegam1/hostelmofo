...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Property Type Listing</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Property Type Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>property_type/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."property_type/batch_action/0/".$page;?>" method="post">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">Property Type Name</th>
                                                ...
                                                if(is_array($propertyTypeList))
                                                {
                                                for($i=0; $i<count($propertyTypeList); $i++)
                                                {
                                                    
                                                 $editLink	= str_replace("{{ID}}",$propertyTypeList[$i]['property_type_id'],$edit_link);
                                                $deleteLink	= str_replace("{{ID}}",$propertyTypeList[$i]['property_type_id'],$delete_link);
                                                ...
                                                if($i%2==0)
                                                  ...
                                                  $class = 'class="odd"';
						  if($propertyTypeList[$i]['status'] == 'Active')
								{
									$status = 'Active';
								}
								else
								{
									$status = 'Inactive';
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($propertyTypeList[$i]['property_type_name']);?></td>
							...
							<?php
											...
											{
											?>
											<label onclick="javascript:statusModifier('property_type',this)" data-team='<?php echo $propertyTypeList[$i]['property_type_id']; ?>' class="btn btn-success"  title="Active"  >
											...
											{
											?>
											<label onclick="javascript:statusModifier('property_type',this)" data-team='<?php echo $propertyTypeList[$i]['property_type_id']; ?>' class="btn btn-primary"  title="Inactive" >
						    ...
						    <img class="loader" id="loader_<?php echo $propertyTypeList[$i]['property_type_id']; ?>" src="<?php echo BACKEND_URL."vendors/pageloader/images/loader7.GIF" ?>" style="width:25px;" /> 
