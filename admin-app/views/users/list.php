                        ...
                        <div id="tableactionTabContent" class="tab-content">
						    ...
						    <th width="5%" align="center">Status</th>
                                                ...
                                                if($db_user_image!='')
                                                {
                                                    ...
                                                    {
                                                        $user_image = IMAGE_UPLOAD_URL."admin/".$adminList[$i]['image'];
                                                    }
                                                    else
                                                    {
                                                ...
                                                <tr>
                                                    <td>
						    <?php if(($adminList[$i]['admin_id'] != 1) && ($adminList[$i]['admin_id'] != 9)){ ?>
						    <input type="checkbox" name="page[]" value="<?php echo $adminList[$i]['admin_id'];?>"/>
						    <?php } ?>
						    </td>
						    ...
						    <td><?php if($adminList[$i]['status']=='active'){  echo '<label class="label label-green">'. ucwords( stripslashes($adminList[$i]['status']));  }else{  echo '<label class="label label-red">'. ucwords( stripslashes($adminList[$i]['status'])); } ?></label></td>
							...
							{
							  if(($session_user_id != $adminList[$i]['admin_id']) && ($adminList[$i]['admin_id'] != 1) && ($adminList[$i]['admin_id'] != 9))
							{
