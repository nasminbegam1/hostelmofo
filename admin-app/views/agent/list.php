...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Agent Listing</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Agent Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>agent/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."agent/batch_action/0/".$page;?>" method="post">
						    ...
						    <th width="5%" align="center">Status</th>
                                                ...
                                                $editLink 	= str_replace("{{ID}}",$agentList[$i]['agent_id'],$edit_link);
                                                $deleteLink 	= str_replace("{{ID}}",$agentList[$i]['agent_id'],$delete_link); 
                                                ?>  
                                                <tr>
                                                    <td><input type="checkbox" name="page[]" value="<?php echo $agentList[$i]['agent_id'];?>"/></td>
                                                    <td><?php echo stripslashes($agentList[$i]['firstname']);?></td>
                                                    <td><?php echo stripslashes($agentList[$i]['lastname']);?></td>
                                                    <td><?php echo stripslashes($agentList[$i]['email']);?></td>
						    <td><?php if($agentList[$i]['status']=='active'){  echo '<label class="label label-green">'. ucwords( stripslashes($agentList[$i]['status']));  }else{  echo '<label class="label label-red">'. ucwords( stripslashes($agentList[$i]['status'])); } ?></label></td>
