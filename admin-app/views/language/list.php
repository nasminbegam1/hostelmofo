...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Language Listing</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Language Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>language/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php //echo BACKEND_URL."language/batch_action/0/".$page;?>" method="post">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                for($i=0; $i<count($languageList); $i++)
                                                {
                                                 ...
                                                 $editLink	= str_replace("{{ID}}",$languageList[$i]['property_language_id'],$edit_link);
                                                $deleteLink	= str_replace("{{ID}}",$languageList[$i]['property_language_id'],$delete_link);
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($languageList[$i]['property_language_name']);?></td>
                                                    
                                                    
                                                    <td style="text-align: center;">
						    <?php
							if($languageList[$i]['status']=='Active')
							{
							?>
							<label onclick="javascript:statusModifier('language',this)" data-team='<?php echo $languageList[$i]['property_language_id']; ?>' class="btn btn-success" title="Active" >
							<i class="fa fa-check-square-o"></i>
							</label>
							
							<?php
							}
							else if($languageList[$i]['status']=='Inactive')
							{
							?>
							<label onclick="javascript:statusModifier('language',this)" data-team='<?php echo $languageList[$i]['property_language_id']; ?>' class="btn btn-primary" title="Inactive" >
						    ...
						    ?>
                                                    ...
                                                    <img class="loader" id="loader_<?php echo $languageList[$i]['property_language_id']; ?>" src="<?php echo BACKEND_URL."vendors/pageloader/images/loader7.GIF" ?>" style="width:25px;" /> 
                                                    </td>
                                                </tr>
                                                <?php } } else {  ?>
