						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="banner_image" class="col-md-3 control-label">Banner Image<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                               <input type="file" name="banner_image"  id="banner_image" />&nbsp;<strong>[image size maximum 1680x773 | extension must be .jpg or .jpeg or .gif or .png]</strong>
                                                               <input type="hidden" name="currentFile" value="<?php echo $arr_banner['banner_image'];?>">
                                                               <br />
                                                            <?php if($arr_banner['banner_image']!=''){ ?>
							    <img src="<?php echo isFileExist(CDN_BANNER_THUMB_IMG.$arr_banner['banner_image']);?>" width="100" hight="100" >
                                                             <?php } ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group"><label for="banner_title" class="col-md-3 control-label">Alt Tag <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="banner_title" type="text" placeholder="Alt Tag" class="form-control required" id="banner_title" value="<?php echo $arr_banner['banner_title'];?>"/>
