...
<!--BEGIN CONTENT-->
            ...
            <div class="page-content">
			    ...
			    <div class="row">
				<form action="" method="post" class="form-validate form-horizontal form-seperated " enctype="multipart/form-data" id="add_form">
							   ...
							   <div class="portlet-body panel-body pan">
								   ...
								   <div class="form-body pal">
									   ...
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										       <input type="text" class="form-control required" name="name" id="name" value="<?php echo stripslashes($arr_team['name']);?>" data-required="true">		
										   </div>
									       </div>
									   </div>
								       </div>
									   ...
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										       <input type="text" class="form-control required" name="designation" id="designation" value="<?php echo stripslashes($arr_team['designation']);?>" data-required="true">
										   </div>
									       </div>
									   </div>
								       </div>
								    ...
								    <br class="spacer" />
									   ...
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										    <input type="text" name="fb_link" id="fb_link" class="form-control" data-required="true" value="<?php echo stripslashes($arr_team['facebook_link']);?>" />
									   ...
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										       <input type="text" name="twitter_link" class="form-control" id="twitter_link" data-required="true" value="<?php echo stripslashes($arr_team['twitter_link']);?>" />				    
										   </div>
									       </div>
									   </div>
								       </div>
									   ...
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										       <input type="text" name="google_link" class="form-control" id="google_link" data-required="true" value="<?php echo stripslashes($arr_team['googleplus_link']);?>">			    
										   </div>
									       </div>
									   </div>
								       </div>
									   ...
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										       <input type="text" name="instragram_link" id="instragram_link" data-required="true" class="form-control" value="<?php echo stripslashes($arr_team['intragram_link']);?>" >				    
										   </div>
									       </div>
									   </div>
								       </div>
									...
									<div class="row">
									   <div class="col-md-12">
										   ...
										   <div class="col-md-7 input-icon">
										       <input type="text" name="linkedin_link" id="linkedin_link" data-required="true" class="form-control" value="<?php echo stripslashes($arr_team['linkedin_link']);?>" >				    
										   </div>
									       </div>
									   </div>
								       </div>
