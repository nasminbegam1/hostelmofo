								...
								?>
									  <tr <?php echo $class; ?> id="tr<?php echo $teamMasterList[$i]['id']; ?>">
										...
										<td align="center">
											...
											{
											?>
											<label onclick="javascript:statusModifier('team',this)" data-team='<?php echo $teamMasterList[$i]['id']; ?>' class="btn btn-success" title="Active"  >
											...
											{
											?>
											<label onclick="javascript:statusModifier('team',this)" data-team='<?php echo $teamMasterList[$i]['id']; ?>' class="btn btn-primary" title="Inactive" >
