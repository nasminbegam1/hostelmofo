...
<!--BEGIN CONTENT-->
        ...
        <div class="col-lg-12">
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
					    ...
					    <form action="<?php echo BACKEND_URL.'property/editcontactaction/'.$property_details['property_master']['property_master_id'] ?>" class="form-horizontal PropEditForm" id="propertyAddFrm" method="post" enctype="multipart/form-data">
				 ...
				 <div class="formPreLoader" style="">
					...
					<div id="tab2-wizard-custom-circle" class="tab-pane active"><!--<h3 class="mbxl">Set up Contact details</h3>-->
						...
						<div class="form-group"><label for="mobile_url" class="col-sm-3 control-label">Send SMS Notification</label>
						...
						<div class="form-group" id="sms_no_sec" style="display: <?php if($property_details['property_master']['sms_notification'] == 'Yes') echo "block"; else echo 'none';?>;"><label for="signed_for" class="col-sm-3 control-label"></label>
						...
						<div class="form-group"><label for="signed_for" class="col-sm-3 control-label">Signed for and on behalf of Licensee</label>
					       ...
					       <div class="form-group"><label for="licensee_name" class="col-sm-3 control-label"> Name (First name, last name)</label>
					       ...
					       <div class="form-group"><label for="licensee_email" class="col-sm-3 control-label">Email Address</label>
					       ...
					       <div class="form-group"><label for="licensee_email2" class="col-sm-3 control-label">Licensees email address for contracts</label>
					       ...
					       <div class="form-group"><label for="signed_date" class="col-sm-3 control-label">Signed date</label>
							    ...
							    if($property_details['property_details']['signed_date'] != '0000-00-00' && $property_details['property_details']['signed_date'] != '1970-01-01') 
							     {
 ...
 <div class="form-group"><label for="effective_date" class="col-sm-3 control-label">Effective Price</label>
							    ...
							    if($property_details['property_master']['effective_date'] !='0000-00-00'  && $property_details['property_master']['effective_date'] != '1970-01-01')
							    {
