...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Property Comment</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 >Property Comment Search Panel</h4>
							...
							<div class="tb-group-actions pull-right">
                                                    <div class="actions"><a href="<?php echo $base_url;?>" class="btn btn-info btn-sm">
                                                   Return</a>&nbsp;
                                                    </div>
                                                    </div>
                                                </div>
					     ...
					     <div id="no-more-tables">
						   ...
						   <th width="10%">User Name</th>
                                                ...
                                                if(is_array($queryList) & !empty($queryList))
                                                {
                                                foreach($queryList as $index=>$qList)
                                                {
						$deletelink 	= str_replace("{{ID}}",$qList['feedback_id'],$delete_link);
						
                                                ?>  
                                                <tr>
						    <td data-title="Feedback Id"><?php echo stripslashes($qList['feedback_id'])?></td>
						    <td data-title="Email"><?php echo stripslashes($qList['email'])?></td>
						    <td data-title="User Name"><?php echo stripslashes($qList['first_name']).' '.stripslashes($qList['last_name'])?></td>
                                                    <td data-title="Comments"><?php echo ($qList['comments']!='')?stripslashes($qList['comments']):'N/A';?></td>
