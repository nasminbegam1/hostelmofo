...
-->					<div style="clear: both"></div>
					...
					<div class="col-sm-4 rentDailyPricePan">
						...
						<div class="input-group">
						    ...
						    <input value="" name="commission_rate[<?php echo date("Y");?>][]" type="text" class="form-control requiredInput " data-required="true" data-type="number" id="commission_rate_1">
					...
					<div class="col-sm-4">
						...
						<div class="input-group">
						    ...
						    <input value="" name="minimum_rental_days[<?php echo date("Y");?>][]" type="text" class="form-control requiredInput" data-required="true" data-type="number" id="minrental_1">
   ...
   <script type="text/javascript" src="<?php echo BACKEND_JS_PATH;?>property_price.js"></script>
</div>
