...
<!--BEGIN CONTENT-->
        ...
        <div class="col-lg-12">
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
					    ...
					    <form action="<?php echo BACKEND_URL.'property/editfacilitiesaction/'.$property_details['property_master']['property_master_id'] ?>" class="form-horizontal form-validate" id="propertyAddFrm" method="post" enctype="multipart/form-data">
