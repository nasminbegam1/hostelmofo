...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        /*$this->options = array(
			...
			$this->options = array(
            'script_url' => 'http://192.168.0.114/livephuket/admin/test/image_upload',
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'] . '/livephuket/upload/property/',
            'upload_url' => 'http://192.168.0.114/livephuket/upload/property/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            // Set the following option to 'POST', if your server does not support
