...
class Model_basic extends CI_Model
{
	...
	public function getSingleRow($TableName, $FieldNames='', $AliasFieldName = '', $Condition='') {
	    if($Condition=="")
		$Condition="";
	    else
		$Condition=" WHERE ".$Condition;
	...
	public function get_settings( $id = '' ){
		$sql = "SELECT sitesettings_id, sitesettings_name, sitesettings_value FROM hw_sitesettings WHERE sitesettings_id in (".$id.") ";
		//echo $sql; exit;
