...
function getfilterresult(showtype){
         ...
         var list_roomtype       = $('.list_roomtype:checked').map(function() {return this.value;}).get().join(',');
			...
			if (showtype == "grid") {
				 var  formData = "guest="+guest+"&minprice="+minprice+"&maxprice="+maxprice+"&sortby="+sortby+"&page="+page+"&perpage="+perpage+"&typeid="+list_ptype+"&roomtype="+list_roomtype+"&city="+list_citytype+"&facilities="+list_facility+"&way=filter&stype=grid&group_type="+group_type+"&age_ranges="+age_ranges;
			}
			else{
				 var  formData 	= "guest="+guest+"&minprice="+minprice+"&maxprice="+maxprice+"&sortby="+sortby+"&page="+page+"&perpage="+perpage+"&typeid="+list_ptype+"&roomtype="+list_roomtype+"&city="+list_citytype+"&facilities="+list_facility+"&way=filter&group_type="+group_type+"&age_ranges="+age_ranges;
			}
